...
-- Create `exception` table for exception management
...
ALTER TABLE `code_list_value`
    ...
    CHANGE COLUMN `name` `meaning` varchar(100) DEFAULT NULL COMMENT 'The description or explanation of the code list value, e.g., ''Each'' for EA, ''English'' for EN.',
...
-- Add `replacement_id` for all components
ALTER TABLE `acc_manifest`
    ADD COLUMN `replacement_acc_manifest_id` bigint(20) unsigned DEFAULT NULL COMMENT 'This refers to a replacement manifest if the record is deprecated.' AFTER `log_id`,
...
ALTER TABLE `asccp_manifest`
    ADD COLUMN `replacement_asccp_manifest_id` bigint(20) unsigned DEFAULT NULL COMMENT 'This refers to a replacement manifest if the record is deprecated.' AFTER `log_id`,
...
ALTER TABLE `bccp_manifest`
    ADD COLUMN `replacement_bccp_manifest_id` bigint(20) unsigned DEFAULT NULL COMMENT 'This refers to a replacement manifest if the record is deprecated.' AFTER `log_id`,
...
ALTER TABLE `dt_manifest`
    ADD COLUMN `replacement_dt_manifest_id` bigint(20) unsigned DEFAULT NULL COMMENT 'This refers to a replacement manifest if the record is deprecated.' AFTER `log_id`,
...
ALTER TABLE `code_list_manifest`
    ADD COLUMN `replacement_code_list_manifest_id` bigint(20) unsigned DEFAULT NULL COMMENT 'This refers to a replacement manifest if the record is deprecated.' AFTER `log_id`,
...
ALTER TABLE `agency_id_list_manifest`
    ADD COLUMN `replacement_agency_id_list_manifest_id` bigint(20) unsigned DEFAULT NULL COMMENT 'This refers to a replacement manifest if the record is deprecated.' AFTER `log_id`,
