...
public interface AgencyIdListWriteRepository {
    BigInteger createAgencyIdList(ScoreUser user, BigInteger releaseId) throws ScoreDataAccessException;
    ...
    void transferOwnerShipAgencyIdList(ScoreUser user, BigInteger agencyIdListManifestId) throws ScoreDataAccessException;
}
