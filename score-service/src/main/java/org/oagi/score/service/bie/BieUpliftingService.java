    ...
    private class BieUpliftingHandler implements BieVisitor {
        ...
        public void visitAsbie(Asbie asbie, BieVisitContext context) {
            ...
            if (targetAssociation == null) {
                ...
                targetAsbie.setBasedAsccManifestId(((AsccManifest) targetAssociation.getCcAssociation()).getAsccManifestId());
                targetAsbie.setPath(targetAssociation.getPath());
        ...
        public void visitBbie(Bbie bbie, BieVisitContext context) {
            ...
            if (targetAssociation == null) {
                ...
                targetBbie.setBasedBccManifestId(((BccManifest) targetAssociation.getCcAssociation()).getBccManifestId());
                targetBbie.setPath(targetAssociation.getPath());
        ...
        public void visitAsbiep(Asbiep asbiep, BieVisitContext context) {
            ...
            if (targetAsccpManifest != null) { // found matched asccp
                ...
                targetAsbiep.setHashPath(sha256(currentTargetPath));
        ...
        public void visitBbiep(Bbiep bbiep, BieVisitContext context) {
            ...
            if (targetBccpManifest != null) {
                ...
                targetBbiep.setBasedBccpManifestId(targetBccpManifest.getBccpManifest().getBccpManifestId());
                targetBbiep.setPath(currentTargetPath + ">" + "BCCP-" + targetBdtManifestId);
