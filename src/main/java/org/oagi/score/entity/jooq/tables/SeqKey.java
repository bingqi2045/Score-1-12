...
public class SeqKey extends TableImpl<SeqKeyRecord> {
     ...
     */
    public final TableField<SeqKeyRecord, SeqKeyType> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR(4).asEnumDataType(SeqKeyType.class), this, "");
