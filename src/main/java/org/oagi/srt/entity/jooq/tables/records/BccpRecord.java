...
public class BccpRecord extends UpdatableRecordImpl<BccpRecord> implements Record22<ULong, String, String, String, ULong, String, String, String, ULong, Byte, ULong, ULong, ULong, Timestamp, Timestamp, Integer, Integer, Integer, Integer, Byte, String, String> {
    ...
    private static final long serialVersionUID = 2021098979;
...
State change can't be undone. But the history record can still keep the records of when the state was changed.
    ...
    @Override
    public Row22<ULong, String, String, String, ULong, String, String, String, ULong, Byte, ULong, ULong, ULong, Timestamp, Timestamp, Integer, Integer, Integer, Integer, Byte, String, String> fieldsRow() {
        return (Row22) super.fieldsRow();
    }

    @Override
    public Row22<ULong, String, String, String, ULong, String, String, String, ULong, Byte, ULong, ULong, ULong, Timestamp, Timestamp, Integer, Integer, Integer, Integer, Byte, String, String> valuesRow() {
