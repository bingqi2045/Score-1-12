...
public class AccRecord extends UpdatableRecordImpl<AccRecord> implements Record22<ULong, String, String, String, String, String, ULong, String, Integer, ULong, ULong, ULong, ULong, ULong, Timestamp, Timestamp, Integer, Integer, Integer, Byte, Byte, Byte> {

    private static final long serialVersionUID = 796123819;
...
State change can't be undone. But the history record can still keep the records of when the state was changed.
    ...
    @Override
    public Row22<ULong, String, String, String, String, String, ULong, String, Integer, ULong, ULong, ULong, ULong, ULong, Timestamp, Timestamp, Integer, Integer, Integer, Byte, Byte, Byte> valuesRow() {
    ...
    @Override
    public AccRecord value16(Timestamp value) {
    ...
    @Override
    public AccRecord value19(Integer value) {
    ...
    @Override
    public AccRecord value22(Byte value) {
        setIsAbstract(value);
        return this;
    }

    @Override
    public AccRecord values(ULong value1, String value2, String value3, String value4, String value5, String value6, ULong value7, String value8, Integer value9, ULong value10, ULong value11, ULong value12, ULong value13, ULong value14, Timestamp value15, Timestamp value16, Integer value17, Integer value18, Integer value19, Byte value20, Byte value21, Byte value22) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccRecord(ULong accId, String guid, String objectClassTerm, String den, String definition, String definitionSource, ULong basedAccId, String objectClassQualifier, Integer oagisComponentType, ULong moduleId, ULong namespaceId, ULong createdBy, ULong ownerUserId, ULong lastUpdatedBy, Timestamp creationTimestamp, Timestamp lastUpdateTimestamp, Integer state, Integer revisionNum, Integer revisionTrackingNum, Byte revisionAction, Byte isDeprecated, Byte isAbstract) {
        super(Acc.ACC);
