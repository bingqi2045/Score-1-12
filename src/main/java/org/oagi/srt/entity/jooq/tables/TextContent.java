...
public class TextContent extends TableImpl<TextContentRecord> {
    ...
    private static final long serialVersionUID = -1854826546;
     ...
     */
    public final TableField<TextContentRecord, ULong> TEXT_CONTENT_ID = createField("text_content_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>oagi.text_content.text_content_type</code>.
     */
    public final TableField<TextContentRecord, String> TEXT_CONTENT_TYPE = createField("text_content_type", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false).defaultValue(org.jooq.impl.DSL.inline("json", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>oagi.text_content.text_content</code>.
     */
    public final TableField<TextContentRecord, String> TEXT_CONTENT_ = createField("text_content", org.jooq.impl.SQLDataType.CLOB, this, "");
