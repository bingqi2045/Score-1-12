...
It should be noted that, per design document, there is no corresponding ABIE created for an ACC which will not show up in the instance document such as ACCs of OAGIS_COMPONENT_TYPE "SEMANTIC_GROUP", "USER_EXTENSION_GROUP", etc.
     */
    public static final Abie ABIE = org.oagi.srt.entity.jooq.tables.Abie.ABIE;
...
In OAGIS, all XSD extensions will be treated as a qualification of an ACC.
     */
    public static final Acc ACC = org.oagi.srt.entity.jooq.tables.Acc.ACC;
     ...
     */
    public static final AgencyIdList AGENCY_ID_LIST = org.oagi.srt.entity.jooq.tables.AgencyIdList.AGENCY_ID_LIST;

    /**
     * This table captures the values within an agency identification list.
     */
    public static final AgencyIdListValue AGENCY_ID_LIST_VALUE = org.oagi.srt.entity.jooq.tables.AgencyIdListValue.AGENCY_ID_LIST_VALUE;

    /**
     * This table captures the user information for authentication and authorization purposes.
     */
    public static final AppUser APP_USER = org.oagi.srt.entity.jooq.tables.AppUser.APP_USER;

    /**
     * An ASBIE represents a relationship/association between two ABIEs through an ASBIEP. It is a contextualization of an ASCC.
     */
    public static final Asbie ASBIE = org.oagi.srt.entity.jooq.tables.Asbie.ASBIE;

    /**
     * ASBIEP represents a role in a usage of an ABIE. It is a contextualization of an ASCCP.
     */
    public static final Asbiep ASBIEP = org.oagi.srt.entity.jooq.tables.Asbiep.ASBIEP;

    /**
     * An ASCC represents a relationship/association between two ACCs through an ASCCP. 
     */
    public static final Ascc ASCC = org.oagi.srt.entity.jooq.tables.Ascc.ASCC;

    /**
     * An ASCCP specifies a role (or property) an ACC may play under another ACC.
     */
    public static final Asccp ASCCP = org.oagi.srt.entity.jooq.tables.Asccp.ASCCP;
     ...
     */
    public static final Bbie BBIE = org.oagi.srt.entity.jooq.tables.Bbie.BBIE;

    /**
     * BBIEP represents the usage of basic property in a specific business context. It is a contextualization of a BCCP.
     */
    public static final Bbiep BBIEP = org.oagi.srt.entity.jooq.tables.Bbiep.BBIEP;
     ...
     */
    public static final BdtPriRestri BDT_PRI_RESTRI = org.oagi.srt.entity.jooq.tables.BdtPriRestri.BDT_PRI_RESTRI;
...
It should be noted that the table does not store the fact about primitive restriction hierarchical relationships. In other words, if a BDT SC is derived from another BDT SC and the derivative BDT SC applies some primitive restrictions, that relationship will not be explicitly stored. The derivative BDT SC points directly to the CDT_AWD_PRI_XPS_TYPE_MAP key rather than the BDT_SC_PRI_RESTRI key.
     */
    public static final BdtScPriRestri BDT_SC_PRI_RESTRI = org.oagi.srt.entity.jooq.tables.BdtScPriRestri.BDT_SC_PRI_RESTRI;
     ...
     */
    public static final BieUsageRule BIE_USAGE_RULE = org.oagi.srt.entity.jooq.tables.BieUsageRule.BIE_USAGE_RULE;
     ...
     */
    public static final BieUserExtRevision BIE_USER_EXT_REVISION = org.oagi.srt.entity.jooq.tables.BieUserExtRevision.BIE_USER_EXT_REVISION;
     ...
     */
    public static final BizCtxAssignment BIZ_CTX_ASSIGNMENT = org.oagi.srt.entity.jooq.tables.BizCtxAssignment.BIZ_CTX_ASSIGNMENT;
     ...
     */
    public static final BizCtxValue BIZ_CTX_VALUE = org.oagi.srt.entity.jooq.tables.BizCtxValue.BIZ_CTX_VALUE;

    /**
     * This table stores schemas whose content is only imported as a whole and is represented in Blob.
     */
    public static final BlobContent BLOB_CONTENT = org.oagi.srt.entity.jooq.tables.BlobContent.BLOB_CONTENT;
     ...
     */
    public static final CdtAwdPri CDT_AWD_PRI = org.oagi.srt.entity.jooq.tables.CdtAwdPri.CDT_AWD_PRI;
...
If we use a separate table for each expression, then we need binding all the way to BDT (or even BBIE) for every new expression. That would be almost like just store a BDT file. But using a column may not work with all kinds of expressions, particulary if it does not map well to the XML schema data types. 
     */
    public static final CdtAwdPriXpsTypeMap CDT_AWD_PRI_XPS_TYPE_MAP = org.oagi.srt.entity.jooq.tables.CdtAwdPriXpsTypeMap.CDT_AWD_PRI_XPS_TYPE_MAP;

    /**
     * This table stores the CDT primitives.
     */
    public static final CdtPri CDT_PRI = org.oagi.srt.entity.jooq.tables.CdtPri.CDT_PRI;
     ...
     */
    public static final CdtScAwdPri CDT_SC_AWD_PRI = org.oagi.srt.entity.jooq.tables.CdtScAwdPri.CDT_SC_AWD_PRI;
     ...
     */
    public static final CdtScAwdPriXpsTypeMap CDT_SC_AWD_PRI_XPS_TYPE_MAP = org.oagi.srt.entity.jooq.tables.CdtScAwdPriXpsTypeMap.CDT_SC_AWD_PRI_XPS_TYPE_MAP;
     ...
     */
    public static final Client CLIENT = org.oagi.srt.entity.jooq.tables.Client.CLIENT;
     ...
     */
    public static final CodeList CODE_LIST = org.oagi.srt.entity.jooq.tables.CodeList.CODE_LIST;
     ...
     */
    public static final CodeListValue CODE_LIST_VALUE = org.oagi.srt.entity.jooq.tables.CodeListValue.CODE_LIST_VALUE;
     ...
     */
    public static final CtxCategory CTX_CATEGORY = org.oagi.srt.entity.jooq.tables.CtxCategory.CTX_CATEGORY;

    /**
     * This table represents a context scheme (a classification scheme) for a context category.
     */
    public static final CtxScheme CTX_SCHEME = org.oagi.srt.entity.jooq.tables.CtxScheme.CTX_SCHEME;

    /**
     * This table stores the context scheme values for a particular context scheme in the CTX_SCHEME table.
     */
    public static final CtxSchemeValue CTX_SCHEME_VALUE = org.oagi.srt.entity.jooq.tables.CtxSchemeValue.CTX_SCHEME_VALUE;

    /**
     * The DT table stores both CDT and BDT. The two types of DTs are differentiated by the TYPE column.
     */
    public static final Dt DT = org.oagi.srt.entity.jooq.tables.Dt.DT;
     ...
     */
    public static final DtSc DT_SC = org.oagi.srt.entity.jooq.tables.DtSc.DT_SC;
     ...
     */
    public static final DtUsageRule DT_USAGE_RULE = org.oagi.srt.entity.jooq.tables.DtUsageRule.DT_USAGE_RULE;
     ...
     */
    public static final Module MODULE = org.oagi.srt.entity.jooq.tables.Module.MODULE;

    /**
     * This table carries the dependency between modules in the MODULE table.
     */
    public static final ModuleDep MODULE_DEP = org.oagi.srt.entity.jooq.tables.ModuleDep.MODULE_DEP;

    /**
     * This table stores information about a namespace. Namespace is the namespace as in the XML schema specification.
     */
    public static final Namespace NAMESPACE = org.oagi.srt.entity.jooq.tables.Namespace.NAMESPACE;
     ...
     */
    public static final TopLevelAbie TOP_LEVEL_ABIE = org.oagi.srt.entity.jooq.tables.TopLevelAbie.TOP_LEVEL_ABIE;
     ...
     */
    public static final UsageRule USAGE_RULE = org.oagi.srt.entity.jooq.tables.UsageRule.USAGE_RULE;
     ...
     */
    public static final UsageRuleExpression USAGE_RULE_EXPRESSION = org.oagi.srt.entity.jooq.tables.UsageRuleExpression.USAGE_RULE_EXPRESSION;
     ...
     */
    public static final Xbt XBT = org.oagi.srt.entity.jooq.tables.Xbt.XBT;
}
