...
public class BdtScPriRestri extends TableImpl<BdtScPriRestriRecord> {
    ...
    private static final long serialVersionUID = 1439257786;
     ...
     */
    public final TableField<BdtScPriRestriRecord, ULong> BDT_SC_PRI_RESTRI_ID = createField("bdt_sc_pri_restri_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary, internal database key.");
     ...
     */
    public final TableField<BdtScPriRestriRecord, ULong> BDT_SC_ID = createField("bdt_sc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the DT_SC table. This column should only refers to a DT_SC that belongs to a BDT (not CDT).");
     ...
     */
    public final TableField<BdtScPriRestriRecord, ULong> CODE_LIST_ID = createField("code_list_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to identify a code list. It allows for a primitive restriction based on a code list.");
     ...
     */
    public final TableField<BdtScPriRestriRecord, ULong> AGENCY_ID_LIST_ID = createField("agency_id_list_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to identify an agency identification list. It allows for a primitive restriction based on such list of values.");
     ...
     */
    public final TableField<BdtScPriRestriRecord, Byte> IS_DEFAULT = createField("is_default", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "This column specifies the default primitive for a BDT. It is typically the most generic primitive allowed for the BDT.");
