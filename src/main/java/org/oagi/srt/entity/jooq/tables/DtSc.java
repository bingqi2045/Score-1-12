...
public class DtSc extends TableImpl<DtScRecord> {
    ...
    private static final long serialVersionUID = -1337246220;
     ...
     */
    public final TableField<DtScRecord, ULong> DT_SC_ID = createField("dt_sc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Internal, primary database key.");
     ...
     */
    public final TableField<DtScRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR(41).nullable(false), this, "A globally unique identifier (GUID) of an SC. Per OAGIS, a GUID is of the form \"oagis-id-\" followed by a 32 Hex character sequence. Note that each SC is considered intrinsic to each DT, so a SC has a different GUID from the based SC, i.e., SC inherited from the based DT has a new, different GUID.");

    /**
     * The column <code>oagi.dt_sc.property_term</code>. Property term of the SC.
     */
    public final TableField<DtScRecord, String> PROPERTY_TERM = createField("property_term", org.jooq.impl.SQLDataType.VARCHAR(60), this, "Property term of the SC.");

    /**
     * The column <code>oagi.dt_sc.representation_term</code>. Representation of the supplementary component.
     */
    public final TableField<DtScRecord, String> REPRESENTATION_TERM = createField("representation_term", org.jooq.impl.SQLDataType.VARCHAR(20), this, "Representation of the supplementary component.");

    /**
     * The column <code>oagi.dt_sc.definition</code>. Description of the supplementary component.
     */
    public final TableField<DtScRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "Description of the supplementary component.");
     ...
     */
    public final TableField<DtScRecord, String> DEFINITION_SOURCE = createField("definition_source", org.jooq.impl.SQLDataType.VARCHAR(200), this, "This is typically a URL identifying the source of the DEFINITION column.");
     ...
     */
    public final TableField<DtScRecord, ULong> OWNER_DT_ID = createField("owner_dt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreigned key to the DT table indicating the data type, to which this supplementary component belongs.");
     ...
     */
    public final TableField<DtScRecord, ULong> BASED_DT_SC_ID = createField("based_dt_sc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the DT_SC table itself. This column is used when the SC is derived from the based DT.");
