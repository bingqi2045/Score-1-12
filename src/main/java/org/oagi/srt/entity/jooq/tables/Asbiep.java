...
public class Asbiep extends TableImpl<AsbiepRecord> {
    ...
    private static final long serialVersionUID = 1459934894;
     ...
     */
    public final TableField<AsbiepRecord, ULong> ASBIEP_ID = createField("asbiep_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "A internal, primary database key of an ASBIEP.");
     ...
     */
    public final TableField<AsbiepRecord, ULong> BASED_ASCCP_ID = createField("based_asccp_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "A foreign key pointing to the ASCCP record. It is the ASCCP, on which the ASBIEP contextualizes.");
     ...
     */
    public final TableField<AsbiepRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "A definition to override the ASCCP's definition. If NULL, it means that the definition should be derived from the based ASCCP on the UI, expression generation, and any API.");
     ...
     */
    public final TableField<AsbiepRecord, String> REMARK = createField("remark", org.jooq.impl.SQLDataType.VARCHAR(225), this, "This column allows the user to specify a context-specific usage of the BIE. It is different from the DEFINITION column in that the DEFINITION column is a description conveying the meaning of the associated concept. Remarks may be a very implementation specific instruction or others. For example, BOM BOD, as an ACC, is a generic BOM structure. In a particular context, a BOM ASBIEP can be a Super BOM. Explanation of the Super BOM concept should be captured in the Definition of the ASBIEP. A remark about that ASBIEP may be \"Type of BOM should be recognized in the BOM/typeCode.\"");
     ...
     */
    public final TableField<AsbiepRecord, ULong> LAST_UPDATED_BY = createField("last_updated_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "A foreign key referring to the last user who has updated the ASBIEP record. ");
     ...
     */
    public final TableField<AsbiepRecord, Timestamp> CREATION_TIMESTAMP = createField("creation_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "Timestamp when the ASBIEP record was first created. ASBIEPs created as children of another ABIE have the same CREATION_TIMESTAMP.");

    /**
     * The column <code>oagi.asbiep.last_update_timestamp</code>. The timestamp when the ASBIEP was last updated.
     */
    public final TableField<AsbiepRecord, Timestamp> LAST_UPDATE_TIMESTAMP = createField("last_update_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "The timestamp when the ASBIEP was last updated.");
     ...
     */
    public final TableField<AsbiepRecord, ULong> OWNER_TOP_LEVEL_ABIE_ID = createField("owner_top_level_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "This is a foriegn key to the ABIE table. It specifies the top-level ABIE, which owns this ASBIEP record.");
