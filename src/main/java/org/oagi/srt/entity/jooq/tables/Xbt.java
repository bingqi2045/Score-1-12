...
public class Xbt extends TableImpl<XbtRecord> {
    ...
    private static final long serialVersionUID = -1013925386;
     ...
     */
    public final TableField<XbtRecord, ULong> XBT_ID = createField("xbt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary, internal database key.");

    /**
     * The column <code>oagi.xbt.name</code>. Human understandable name of the built-in type.
     */
    public final TableField<XbtRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(45), this, "Human understandable name of the built-in type.");
     ...
     */
    public final TableField<XbtRecord, ULong> SUBTYPE_OF_XBT_ID = createField("subtype_of_xbt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the XBT table itself. It indicates a super type of this XSD built-in type.");

    /**
     * The column <code>oagi.xbt.schema_definition</code>.
     */
    public final TableField<XbtRecord, String> SCHEMA_DEFINITION = createField("schema_definition", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>oagi.xbt.module_id</code>.
     */
    public final TableField<XbtRecord, ULong> MODULE_ID = createField("module_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>oagi.xbt.release_id</code>.
     */
    public final TableField<XbtRecord, ULong> RELEASE_ID = createField("release_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>oagi.xbt.revision_doc</code>.
     */
    public final TableField<XbtRecord, String> REVISION_DOC = createField("revision_doc", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>oagi.xbt.state</code>.
     */
    public final TableField<XbtRecord, Integer> STATE = createField("state", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>oagi.xbt.created_by</code>.
     */
    public final TableField<XbtRecord, ULong> CREATED_BY = createField("created_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>oagi.xbt.owner_user_id</code>.
     */
    public final TableField<XbtRecord, ULong> OWNER_USER_ID = createField("owner_user_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>oagi.xbt.last_updated_by</code>.
     */
    public final TableField<XbtRecord, ULong> LAST_UPDATED_BY = createField("last_updated_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>oagi.xbt.creation_timestamp</code>.
     */
    public final TableField<XbtRecord, Timestamp> CREATION_TIMESTAMP = createField("creation_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>oagi.xbt.last_update_timestamp</code>.
     */
    public final TableField<XbtRecord, Timestamp> LAST_UPDATE_TIMESTAMP = createField("last_update_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>oagi.xbt.revision_num</code>.
     */
    public final TableField<XbtRecord, Integer> REVISION_NUM = createField("revision_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>oagi.xbt.revision_tracking_num</code>.
     */
    public final TableField<XbtRecord, Integer> REVISION_TRACKING_NUM = createField("revision_tracking_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>oagi.xbt.revision_action</code>.
     */
    public final TableField<XbtRecord, Byte> REVISION_ACTION = createField("revision_action", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>oagi.xbt.current_xbt_id</code>.
     */
    public final TableField<XbtRecord, ULong> CURRENT_XBT_ID = createField("current_xbt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>oagi.xbt.is_deprecated</code>.
     */
    public final TableField<XbtRecord, Byte> IS_DEPRECATED = createField("is_deprecated", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");
