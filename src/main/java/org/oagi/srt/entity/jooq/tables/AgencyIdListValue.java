...
public class AgencyIdListValue extends TableImpl<AgencyIdListValueRecord> {
    ...
    private static final long serialVersionUID = 2032780337;
     ...
     */
    public final TableField<AgencyIdListValueRecord, ULong> AGENCY_ID_LIST_VALUE_ID = createField("agency_id_list_value_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary key column.");

    /**
     * The column <code>oagi.agency_id_list_value.value</code>. A value in the agency identification list.
     */
    public final TableField<AgencyIdListValueRecord, String> VALUE = createField("value", org.jooq.impl.SQLDataType.VARCHAR(150).nullable(false), this, "A value in the agency identification list.");

    /**
     * The column <code>oagi.agency_id_list_value.name</code>. Descriptive or short name of the value.
     */
    public final TableField<AgencyIdListValueRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(150), this, "Descriptive or short name of the value.");

    /**
     * The column <code>oagi.agency_id_list_value.definition</code>. The meaning of the value.
     */
    public final TableField<AgencyIdListValueRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "The meaning of the value.");
     ...
     */
    public final TableField<AgencyIdListValueRecord, ULong> OWNER_LIST_ID = createField("owner_list_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the agency identification list in the AGENCY_ID_LIST table this value belongs to.");
