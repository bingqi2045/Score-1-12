...
public class RevisionRecord extends UpdatableRecordImpl<RevisionRecord> implements Record9<ULong, UInteger, UInteger, String, String, JSON, ULong, ULong, LocalDateTime> {

    private static final long serialVersionUID = -833079236;
    ...
    /**
     * Setter for <code>oagi.revision.body</code>.
     */
    ...
    /**
     * Getter for <code>oagi.revision.body</code>.
     */
    public JSON getBody() {
        return (JSON) get(5);
    }
    ...
    @Override
    public Row9<ULong, UInteger, UInteger, String, String, JSON, ULong, ULong, LocalDateTime> fieldsRow() {
        return (Row9) super.fieldsRow();
    }

    @Override
    public Row9<ULong, UInteger, UInteger, String, String, JSON, ULong, ULong, LocalDateTime> valuesRow() {
    ...
    @Override
    public RevisionRecord values(ULong value1, UInteger value2, UInteger value3, String value4, String value5, JSON value6, ULong value7, ULong value8, LocalDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RevisionRecord(ULong revisionId, UInteger revisionNum, UInteger revisionTrackingNum, String revisionAction, String reference, JSON body, ULong prevRevisionId, ULong createdBy, LocalDateTime creationTimestamp) {
        super(Revision.REVISION);
