...
public class BizCtxAssignment extends TableImpl<BizCtxAssignmentRecord> {
    ...
    private static final long serialVersionUID = -615651953;
     ...
     */
    public final TableField<BizCtxAssignmentRecord, ULong> BIZ_CTX_ASSIGNMENT_ID = createField("biz_ctx_assignment_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>oagi.biz_ctx_assignment.biz_ctx_id</code>.
     */
    public final TableField<BizCtxAssignmentRecord, ULong> BIZ_CTX_ID = createField("biz_ctx_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>oagi.biz_ctx_assignment.top_level_abie_id</code>.
     */
    public final TableField<BizCtxAssignmentRecord, ULong> TOP_LEVEL_ABIE_ID = createField("top_level_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BIZ_CTX_ASSIGNMENT_FROM_BIZ_CTX_ID, Indexes.BIZ_CTX_ASSIGNMENT_PRIMARY, Indexes.BIZ_CTX_ASSIGNMENT_TOP_LEVEL_ABIE_ID);
    }
    ...
    public List<UniqueKey<BizCtxAssignmentRecord>> getKeys() {
        return Arrays.<UniqueKey<BizCtxAssignmentRecord>>asList(Keys.KEY_BIZ_CTX_ASSIGNMENT_PRIMARY);
    }
