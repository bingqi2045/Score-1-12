...
public class UsageRuleExpression extends TableImpl<UsageRuleExpressionRecord> {
    ...
    private static final long serialVersionUID = -1383600000;
     ...
     */
    public final TableField<UsageRuleExpressionRecord, ULong> USAGE_RULE_EXPRESSION_ID = createField("usage_rule_expression_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary key of the usage rule expression");
     ...
     */
    public final TableField<UsageRuleExpressionRecord, String> CONSTRAINT_TEXT = createField("constraint_text", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "This column capture the constraint expressing the usage rule. In other words, this is the expression.");

    /**
     * The column <code>oagi.usage_rule_expression.represented_usage_rule_id</code>. The usage rule which the expression represents
     */
    public final TableField<UsageRuleExpressionRecord, ULong> REPRESENTED_USAGE_RULE_ID = createField("represented_usage_rule_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "The usage rule which the expression represents");
