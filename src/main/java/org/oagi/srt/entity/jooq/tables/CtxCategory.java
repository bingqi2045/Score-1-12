...
public class CtxCategory extends TableImpl<CtxCategoryRecord> {
    ...
    private static final long serialVersionUID = -617314810;
     ...
     */
    public final TableField<CtxCategoryRecord, ULong> CTX_CATEGORY_ID = createField("ctx_category_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Internal, primary, database key.");
     ...
     */
    public final TableField<CtxCategoryRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR(41).nullable(false), this, "GUID of the context category.  Per OAGIS, a GUID is of the form \"oagis-id-\" followed by a 32 Hex character sequence.");

    /**
     * The column <code>oagi.ctx_category.name</code>. Short name of the context category.
     */
    public final TableField<CtxCategoryRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(45), this, "Short name of the context category.");

    /**
     * The column <code>oagi.ctx_category.description</code>. Explanation of what the context category is.
     */
    public final TableField<CtxCategoryRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.CLOB, this, "Explanation of what the context category is.");
