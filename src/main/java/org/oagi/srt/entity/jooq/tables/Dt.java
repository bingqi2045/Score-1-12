...
public class Dt extends TableImpl<DtRecord> {
    ...
    private static final long serialVersionUID = 1218586592;
     ...
     */
    public final TableField<DtRecord, ULong> DT_ID = createField("dt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Internal, primary database key.");
     ...
     */
    public final TableField<DtRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR(41).nullable(false), this, "GUID of the data type. Per OAGIS, a GUID is of the form \"oagis-id-\" followed by a 32 Hex character sequence.");

    /**
     * The column <code>oagi.dt.type</code>. List value: 0 = CDT, 1 = BDT.
     */
    public final TableField<DtRecord, Integer> TYPE = createField("type", org.jooq.impl.SQLDataType.INTEGER, this, "List value: 0 = CDT, 1 = BDT.");
     ...
     */
    public final TableField<DtRecord, ULong> PREVIOUS_VERSION_DT_ID = createField("previous_version_dt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foregin key to the DT table itself. It identifies the previous version.");
     ...
     */
    public final TableField<DtRecord, String> QUALIFIER = createField("qualifier", org.jooq.impl.SQLDataType.VARCHAR(100), this, "This column shall be blank when the DT_TYPE is CDT. When the DT_TYPE is BDT, this is optional. If the column is not blank it is a qualified BDT. If blank then the row may be a default BDT or an unqualified BDT. Default BDT is OAGIS concrete implementation of the CDT, these are the DT with numbers in the name, e.g., CodeType_1E7368 (DEN is 'Code_1E7368. Type'). Default BDTs are almost like permutation of the CDT options into concrete data types. Unqualified BDT is a BDT that OAGIS model schema generally used for its canonical. A handful of default BDTs were selected; and each of them is wrapped with another type definition that has a simpler name such as CodeType and NormalizedString type - we call these \"unqualified BDTs\". ");
     ...
     */
    public final TableField<DtRecord, ULong> BASED_DT_ID = createField("based_dt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key pointing to the DT table itself. This column must be blank when the DT_TYPE is CDT. This column must not be blank when the DT_TYPE is BDT.");

    /**
     * The column <code>oagi.dt.den</code>. Dictionary Entry Name of the data type. 
     */
    public final TableField<DtRecord, String> DEN = createField("den", org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "Dictionary Entry Name of the data type. ");
     ...
     */
    public final TableField<DtRecord, String> CONTENT_COMPONENT_DEN = createField("content_component_den", org.jooq.impl.SQLDataType.VARCHAR(200), this, "When the DT_TYPE is CDT this column is automatically derived from DATA_TYPE_TERM as \"<DATA_TYPE_TYPE>. Content\", where 'Content' is called property term of the content component according to CCTS. When the DT_TYPE is BDT this column has the same value as its BASED_DT_ID.");

    /**
     * The column <code>oagi.dt.definition</code>. Description of the data type.
     */
    public final TableField<DtRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "Description of the data type.");

    /**
     * The column <code>oagi.dt.definition_source</code>. This is typically a URL identifying the source of the DEFINITION column.
     */
    public final TableField<DtRecord, String> DEFINITION_SOURCE = createField("definition_source", org.jooq.impl.SQLDataType.VARCHAR(200), this, "This is typically a URL identifying the source of the DEFINITION column.");

    /**
     * The column <code>oagi.dt.content_component_definition</code>. Description of the content component of the data type.
     */
    public final TableField<DtRecord, String> CONTENT_COMPONENT_DEFINITION = createField("content_component_definition", org.jooq.impl.SQLDataType.CLOB, this, "Description of the content component of the data type.");
     ...
     */
    public final TableField<DtRecord, String> REVISION_DOC = createField("revision_doc", org.jooq.impl.SQLDataType.CLOB, this, "This is for documenting about the revision, e.g., how the newer version of the DT is different from the previous version.");
     ...
     */
    public final TableField<DtRecord, Integer> STATE = createField("state", org.jooq.impl.SQLDataType.INTEGER, this, "1 = EDITING, 2 = CANDIDATE, 3 = PUBLISHED. This the revision life cycle state of the entity.\\n\\nState change can't be undone. But the history record can still keep the records of when the state was changed.");
     ...
     */
    public final TableField<DtRecord, ULong> MODULE_ID = createField("module_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the MODULE table indicating physical file where the DT shall belong to when it is generated in an expression. ");

    /**
     * The column <code>oagi.dt.created_by</code>. Foreign key to the APP_USER table. It indicates the user who created this DT.
     */
    public final TableField<DtRecord, ULong> CREATED_BY = createField("created_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the APP_USER table. It indicates the user who created this DT.");
...
In the history record, this should always be the user who is editing the entity (perhaps except when the ownership has just been changed).
     */
    public final TableField<DtRecord, ULong> LAST_UPDATED_BY = createField("last_updated_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the APP_USER table referring to the last user who updated the record. \n\nIn the history record, this should always be the user who is editing the entity (perhaps except when the ownership has just been changed).");
     ...
     */
    public final TableField<DtRecord, ULong> OWNER_USER_ID = createField("owner_user_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the APP_USER table. This is the user who owns the entity, is allowed to edit the entity, and who can transfer the ownership to another user.\\n\\nThe ownership can change throughout the history, but undoing shouldn't rollback the ownership. ");
...
This never change for a revision.
     */
    public final TableField<DtRecord, Timestamp> CREATION_TIMESTAMP = createField("creation_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "Timestamp when the revision of the DT was created. \n\nThis never change for a revision.");
...
The value of this column in the latest history record should be the same as that of the current record. This column keeps the record of when the revision has occurred.
     */
    public final TableField<DtRecord, Timestamp> LAST_UPDATE_TIMESTAMP = createField("last_update_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "Timestamp when the record was last updated.\n\nThe value of this column in the latest history record should be the same as that of the current record. This column keeps the record of when the revision has occurred.");
     ...
     */
    public final TableField<DtRecord, Integer> REVISION_TRACKING_NUM = createField("revision_tracking_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "REVISION_TRACKING_NUM supports the ability to undo changes during a revision (life cycle of a revision is from the component's EDITING state to PUBLISHED state). Once the component has transitioned into the PUBLISHED state for its particular revision, all revision tracking records are deleted except the latest one. REVISION_TRACKING_NUM can be 0, 1, 2, and so on. The zero value is assign to the record with REVISION_NUM = 0 as a default.");
