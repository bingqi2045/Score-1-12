...
public class AsccManifestRecord extends UpdatableRecordImpl<AsccManifestRecord> implements Record9<ULong, ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = -388422652;
    ...
    /**
     * Setter for <code>oagi.ascc_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    /**
     * Getter for <code>oagi.ascc_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    public Field<ULong> field7() {
        return AsccManifest.ASCC_MANIFEST.REVISION_ID;
    }
    ...
    @Override
    public AsccManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, Byte value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AsccManifestRecord(ULong asccManifestId, ULong releaseId, ULong asccId, ULong fromAccManifestId, ULong toAsccpManifestId, Byte conflict, ULong revisionId, ULong prevAsccManifestId, ULong nextAsccManifestId) {
        super(AsccManifest.ASCC_MANIFEST);
