...
public class AsccManifestRecord extends UpdatableRecordImpl<AsccManifestRecord> implements Record8<ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = 1856991877;
    ...
    @Override
    public AsccManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AsccManifestRecord(ULong asccManifestId, ULong releaseId, ULong asccId, ULong fromAccManifestId, ULong toAsccpManifestId, ULong revisionId, ULong prevAsccManifestId, ULong nextAsccManifestId) {
        super(AsccManifest.ASCC_MANIFEST);
