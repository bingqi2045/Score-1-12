...
public class Revision extends TableImpl<RevisionRecord> {
    ...
    private static final long serialVersionUID = -369862173;
     ...
     */
    public final TableField<RevisionRecord, String> REFERENCE = createField(DSL.name("reference"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>oagi.revision.body</code>.
     */
    public final TableField<RevisionRecord, JSON> BODY = createField(DSL.name("body"), org.jooq.impl.SQLDataType.JSON, this, "");
    ...
    public List<ForeignKey<RevisionRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<RevisionRecord, ?>>asList(Keys.REVISION_PREV_REVISION_ID_FK, Keys.REVISION_CREATED_BY_FK);
    }
