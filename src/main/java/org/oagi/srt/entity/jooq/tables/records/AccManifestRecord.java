...
public class AccManifestRecord extends UpdatableRecordImpl<AccManifestRecord> implements Record8<ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = 259538021;
    ...
    @Override
    public AccManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccManifestRecord(ULong accManifestId, ULong releaseId, ULong moduleId, ULong accId, ULong basedAccManifestId, ULong revisionId, ULong prevAccManifestId, ULong nextAccManifestId) {
        super(AccManifest.ACC_MANIFEST);
        ...
        set(5, revisionId);
        set(6, prevAccManifestId);
        set(7, nextAccManifestId);
    }
}
