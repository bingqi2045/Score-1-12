...
public class AccManifestRecord extends UpdatableRecordImpl<AccManifestRecord> implements Record9<ULong, ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {

    private static final long serialVersionUID = 1099311173;
    ...
    @Override
    public AccManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, Byte value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccManifestRecord(ULong accManifestId, ULong releaseId, ULong moduleId, ULong accId, ULong basedAccManifestId, Byte conflict, ULong revisionId, ULong prevAccManifestId, ULong nextAccManifestId) {
        super(AccManifest.ACC_MANIFEST);
