...
public class DtManifestRecord extends UpdatableRecordImpl<DtManifestRecord> implements Record8<ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {

    private static final long serialVersionUID = 1294148580;
    ...
    @Override
    public DtManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, Byte value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DtManifestRecord(ULong dtManifestId, ULong releaseId, ULong moduleId, ULong dtId, Byte conflict, ULong revisionId, ULong prevDtManifestId, ULong nextDtManifestId) {
        super(DtManifest.DT_MANIFEST);
