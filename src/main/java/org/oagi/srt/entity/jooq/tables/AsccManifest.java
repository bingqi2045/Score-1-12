...
public class AsccManifest extends TableImpl<AsccManifestRecord> {
    ...
    private static final long serialVersionUID = 816581593;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ASCC_MANIFEST_ASCC_MANIFEST_ASCC_ID_FK, Indexes.ASCC_MANIFEST_ASCC_MANIFEST_FROM_ACC_MANIFEST_ID_FK, Indexes.ASCC_MANIFEST_ASCC_MANIFEST_RELEASE_ID_FK, Indexes.ASCC_MANIFEST_ASCC_MANIFEST_TO_ASCCP_MANIFEST_ID_FK, Indexes.ASCC_MANIFEST_PRIMARY);
    }
