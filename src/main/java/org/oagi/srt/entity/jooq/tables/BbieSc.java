...
public class BbieSc extends TableImpl<BbieScRecord> {
    ...
    private static final long serialVersionUID = -1144928023;
     ...
     */
    public final TableField<BbieScRecord, ULong> BBIE_SC_ID = createField("bbie_sc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "A internal, primary database key of a BBIE_SC.");
     ...
     */
    public final TableField<BbieScRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR(41).nullable(false), this, "A globally unique identifier (GUID). It is different from the GUID fo the SC on the CC side. Per OAGIS, a GUID is of the form \"oagis-id-\" followed by a 32 Hex character sequence.");

    /**
     * The column <code>oagi.bbie_sc.bbie_id</code>. The BBIE this BBIE_SC applies to.
     */
    public final TableField<BbieScRecord, ULong> BBIE_ID = createField("bbie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "The BBIE this BBIE_SC applies to.");
     ...
     */
    public final TableField<BbieScRecord, ULong> DT_SC_ID = createField("dt_sc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the DT_SC table. This should correspond to the DT_SC of the BDT of the based BCC and BCCP.");
...
This column, the CODE_LIST_ID column, and AGENCY_ID_LIST_ID column cannot have a value at the same time.
     */
    public final TableField<BbieScRecord, ULong> DT_SC_PRI_RESTRI_ID = createField("dt_sc_pri_restri_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "This must be one of the allowed primitive/code list as specified in the corresponding SC of the based BCC of the BBIE (referred to by the BBIE_ID column).\n\nIt is the foreign key to the BDT_SC_PRI_RESTRI table. It indicates the primitive assigned to the BBIE (or also can be viewed as assigned to the BBIEP for this specific association). This is assigned by the user who authors the BIE. The assignment would override the default from the CC side.\n\nThis column, the CODE_LIST_ID column, and AGENCY_ID_LIST_ID column cannot have a value at the same time.");
...
This column, the DT_SC_PRI_RESTRI_ID column, and CODE_LIST_ID column cannot have a value at the same time.
     ...
     */
    public final TableField<BbieScRecord, Integer> CARDINALITY_MIN = createField("cardinality_min", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "The minimum occurrence constraint for the BBIE SC. A valid value is 0 or 1.");

    /**
     * The column <code>oagi.bbie_sc.cardinality_max</code>. Maximum occurence constraint of the BBIE SC. A valid value is 0 or 1.
     */
    public final TableField<BbieScRecord, Integer> CARDINALITY_MAX = createField("cardinality_max", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Maximum occurence constraint of the BBIE SC. A valid value is 0 or 1.");
     ...
     */
    public final TableField<BbieScRecord, String> DEFAULT_VALUE = createField("default_value", org.jooq.impl.SQLDataType.CLOB, this, "This column specifies the default value constraint. Default and fixed value constraints cannot be used at the same time.");
     ...
     */
    public final TableField<BbieScRecord, String> FIXED_VALUE = createField("fixed_value", org.jooq.impl.SQLDataType.CLOB, this, "This column captures the fixed value constraint. Default and fixed value constraints cannot be used at the same time.");
     ...
     */
    public final TableField<BbieScRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "Description to override the BDT SC definition. If NULL, it means that the definition should be inherited from the based BDT SC.");

    /**
     * The column <code>oagi.bbie_sc.example_text_content_id</code>.
     */
    public final TableField<BbieScRecord, ULong> EXAMPLE_TEXT_CONTENT_ID = createField("example_text_content_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");
     ...
     */
    public final TableField<BbieScRecord, String> REMARK = createField("remark", org.jooq.impl.SQLDataType.VARCHAR(225), this, "This column allows the user to specify a very context-specific usage of the BBIE SC. It is different from the Definition column in that the Definition column is a description conveying the meaning of the associated concept. Remarks may be a very implementation specific instruction or others. ");
     ...
     */
    public final TableField<BbieScRecord, String> BIZ_TERM = createField("biz_term", org.jooq.impl.SQLDataType.VARCHAR(225), this, "Business term to indicate what the BBIE SC is called in a particular business context. With this current design, only one business term is allowed per business context.");
     ...
     */
    public final TableField<BbieScRecord, ULong> OWNER_TOP_LEVEL_ABIE_ID = createField("owner_top_level_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "This is a foriegn key to the ABIE. It specifies the top-level ABIE, which owns this BBIE_SC record.");
