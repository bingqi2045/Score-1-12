...
public class Bbie extends TableImpl<BbieRecord> {
    ...
    private static final long serialVersionUID = -1634894995;
     ...
     */
    public final TableField<BbieRecord, ULong> BBIE_ID = createField("bbie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "A internal, primary database key of a BBIE.");
     ...
     */
    public final TableField<BbieRecord, ULong> BASED_BCC_ID = createField("based_bcc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "The BASED_BCC_ID column refers to the BCC record, which this BBIE contextualizes.");

    /**
     * The column <code>oagi.bbie.from_abie_id</code>. FROM_ABIE_ID must be based on the FROM_ACC_ID in the BASED_BCC_ID.
     */
    public final TableField<BbieRecord, ULong> FROM_ABIE_ID = createField("from_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "FROM_ABIE_ID must be based on the FROM_ACC_ID in the BASED_BCC_ID.");
     ...
     */
    public final TableField<BbieRecord, ULong> AGENCY_ID_LIST_ID = createField("agency_id_list_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "This is a foreign key to the AGENCY_ID_LIST table. It is used in the case that the BDT content can be restricted to an agency identification.");
     ...
     */
    public final TableField<BbieRecord, Integer> CARDINALITY_MIN = createField("cardinality_min", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "The minimum occurrence constraint for the BBIE. A valid value is a non-negative integer.");
     ...
     */
    public final TableField<BbieRecord, Integer> CARDINALITY_MAX = createField("cardinality_max", org.jooq.impl.SQLDataType.INTEGER, this, "Maximum occurence constraint of the TO_BBIEP_ID. A valid value is an integer from -1 and up. Specifically, -1 means unbounded. 0 means prohibited or not to use.");
     ...
     */
    public final TableField<BbieRecord, String> DEFAULT_VALUE = createField("default_value", org.jooq.impl.SQLDataType.CLOB, this, "This column specifies the default value constraint. Default and fixed value constraints cannot be used at the same time.");
     ...
     */
    public final TableField<BbieRecord, String> FIXED_VALUE = createField("fixed_value", org.jooq.impl.SQLDataType.CLOB, this, "This column captures the fixed value constraint. Default and fixed value constraints cannot be used at the same time.");
     ...
     */
    public final TableField<BbieRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "Description to override the BCC definition. If NULLl, it means that the definition should be inherited from the based BCC.");

    /**
     * The column <code>oagi.bbie.example_text_content_id</code>.
     */
    public final TableField<BbieRecord, ULong> EXAMPLE_TEXT_CONTENT_ID = createField("example_text_content_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "");
     ...
     */
    public final TableField<BbieRecord, String> REMARK = createField("remark", org.jooq.impl.SQLDataType.VARCHAR(225), this, "This column allows the user to specify very context-specific usage of the BIE. It is different from the DEFINITION column in that the DEFINITION column is a description conveying the meaning of the associated concept. Remarks may be a very implementation specific instruction or others. For example, BOM BOD, as an ACC, is a generic BOM structure. In a particular context, a BOM ABIE can be a Super BOM. Explanation of the Super BOM concept should be captured in the Definition of the ABIE. A remark about that ABIE may be \"Type of BOM should be recognized in the BOM/typeCode.\"");
     ...
     */
    public final TableField<BbieRecord, Timestamp> CREATION_TIMESTAMP = createField("creation_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "Timestamp when the BBIE record was first created. BBIEs created as children of another ABIE have the same CREATION_TIMESTAMP.");

    /**
     * The column <code>oagi.bbie.last_update_timestamp</code>. The timestamp when the ASBIE was last updated.
     */
    public final TableField<BbieRecord, Timestamp> LAST_UPDATE_TIMESTAMP = createField("last_update_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "The timestamp when the ASBIE was last updated.");
     ...
     */
    public final TableField<BbieRecord, ULong> OWNER_TOP_LEVEL_ABIE_ID = createField("owner_top_level_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "This is a foriegn key to the ABIE table. It specifies the top-level ABIE, which owns this BBIE record.");
