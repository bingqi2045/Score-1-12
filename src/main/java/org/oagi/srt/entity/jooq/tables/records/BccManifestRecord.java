...
public class BccManifestRecord extends UpdatableRecordImpl<BccManifestRecord> implements Record8<ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = 407899993;
    ...
    /**
     * Setter for <code>oagi.bcc_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    /**
     * Getter for <code>oagi.bcc_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    public Field<ULong> field6() {
        return BccManifest.BCC_MANIFEST.REVISION_ID;
    }
    ...
    @Override
    public BccManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BccManifestRecord(ULong bccManifestId, ULong releaseId, ULong bccId, ULong fromAccManifestId, ULong toBccpManifestId, ULong revisionId, ULong prevBccManifestId, ULong nextBccManifestId) {
        super(BccManifest.BCC_MANIFEST);
