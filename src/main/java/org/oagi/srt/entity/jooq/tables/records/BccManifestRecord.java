...
public class BccManifestRecord extends UpdatableRecordImpl<BccManifestRecord> implements Record9<ULong, ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = -510053678;
    ...
    @Override
    public BccManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, Byte value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BccManifestRecord(ULong bccManifestId, ULong releaseId, ULong bccId, ULong fromAccManifestId, ULong toBccpManifestId, Byte conflict, ULong revisionId, ULong prevBccManifestId, ULong nextBccManifestId) {
        super(BccManifest.BCC_MANIFEST);
