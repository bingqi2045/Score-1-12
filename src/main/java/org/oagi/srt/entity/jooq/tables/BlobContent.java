...
public class BlobContent extends TableImpl<BlobContentRecord> {
    ...
    private static final long serialVersionUID = 533705461;
     ...
     */
    public final TableField<BlobContentRecord, ULong> BLOB_CONTENT_ID = createField("blob_content_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary, internal database key.");

    /**
     * The column <code>oagi.blob_content.content</code>. The Blob content of the schema file.
     */
    public final TableField<BlobContentRecord, byte[]> CONTENT = createField("content", org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "The Blob content of the schema file.");

    /**
     * The column <code>oagi.blob_content.release_id</code>. The release to which this file/content belongs/published.
     */
    public final TableField<BlobContentRecord, ULong> RELEASE_ID = createField("release_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "The release to which this file/content belongs/published.");
     ...
     */
    public final TableField<BlobContentRecord, ULong> MODULE_ID = createField("module_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the module table indicating the physical file the blob content should be output to when generating/serializing the content.");
