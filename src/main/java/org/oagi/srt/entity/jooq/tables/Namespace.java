...
public class Namespace extends TableImpl<NamespaceRecord> {
    ...
    private static final long serialVersionUID = 886029560;
     ...
     */
    public final TableField<NamespaceRecord, ULong> NAMESPACE_ID = createField("namespace_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary, internal database key.");

    /**
     * The column <code>oagi.namespace.uri</code>. This is the URI of the namespace.
     */
    public final TableField<NamespaceRecord, String> URI = createField("uri", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "This is the URI of the namespace.");
     ...
     */
    public final TableField<NamespaceRecord, String> PREFIX = createField("prefix", org.jooq.impl.SQLDataType.VARCHAR(45), this, "This is a default short name to represent the URI. It may be overridden during the expression generation. Null or empty means the same thing like the default prefix in an XML schema.");

    /**
     * The column <code>oagi.namespace.description</code>. Description or explanation about the namespace or use of the namespace.
     */
    public final TableField<NamespaceRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.CLOB, this, "Description or explanation about the namespace or use of the namespace.");
     ...
     */
    public final TableField<NamespaceRecord, ULong> OWNER_USER_ID = createField("owner_user_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the APP_USER table identifying the user who can update or delete the record.");
     ...
     */
    public final TableField<NamespaceRecord, ULong> CREATED_BY = createField("created_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the APP_USER table identifying user who created the namespace.");
     ...
     */
    public final TableField<NamespaceRecord, ULong> LAST_UPDATED_BY = createField("last_updated_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the APP_USER table identifying the user who last updated the record.");

    /**
     * The column <code>oagi.namespace.creation_timestamp</code>. The timestamp when the record was first created.
     */
    public final TableField<NamespaceRecord, Timestamp> CREATION_TIMESTAMP = createField("creation_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "The timestamp when the record was first created.");

    /**
     * The column <code>oagi.namespace.last_update_timestamp</code>. The timestamp when the record was last updated.
     */
    public final TableField<NamespaceRecord, Timestamp> LAST_UPDATE_TIMESTAMP = createField("last_update_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "The timestamp when the record was last updated.");
