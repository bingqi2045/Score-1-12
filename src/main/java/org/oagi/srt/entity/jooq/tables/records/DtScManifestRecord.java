...
public class DtScManifestRecord extends UpdatableRecordImpl<DtScManifestRecord> implements Record8<ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = 990659136;
     ...
     */
    public DtScManifestRecord(ULong dtScManifestId, ULong releaseId, ULong dtScId, ULong ownerDtManifestId, Byte conflict, ULong revisionId, ULong prevDtScManifestId, ULong nextDtScManifestId) {
        super(DtScManifest.DT_SC_MANIFEST);
