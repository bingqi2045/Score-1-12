...
public class DtScManifestRecord extends UpdatableRecordImpl<DtScManifestRecord> implements Record7<ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = 1722486962;
    ...
    /**
     * Setter for <code>oagi.dt_sc_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    /**
     * Getter for <code>oagi.dt_sc_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    @Override
    public DtScManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DtScManifestRecord(ULong dtScManifestId, ULong releaseId, ULong dtScId, ULong ownerDtManifestId, ULong revisionId, ULong prevDtScManifestId, ULong nextDtScManifestId) {
        super(DtScManifest.DT_SC_MANIFEST);
