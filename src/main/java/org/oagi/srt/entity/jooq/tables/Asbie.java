...
public class Asbie extends TableImpl<AsbieRecord> {
    ...
    private static final long serialVersionUID = -211394321;
     ...
     */
    public final TableField<AsbieRecord, ULong> ASBIE_ID = createField("asbie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "A internal, primary database key of an ASBIE.");
     ...
     */
    public final TableField<AsbieRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR(41).nullable(false), this, "A globally unique identifier (GUID) of an ASBIE. GUID of an ASBIE is different from its based ASCC. Per OAGIS, a GUID is of the form \"oagis-id-\" followed by a 32 Hex character sequence.");
     ...
     */
    public final TableField<AsbieRecord, ULong> FROM_ABIE_ID = createField("from_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "A foreign key pointing to the ABIE table. FROM_ABIE_ID is basically  a parent data element (type) of the TO_ASBIEP_ID. FROM_ABIE_ID must be based on the FROM_ACC_ID in the BASED_ASCC_ID except when the FROM_ACC_ID refers to an SEMANTIC_GROUP ACC or USER_EXTENSION_GROUP ACC.");
     ...
     */
    public final TableField<AsbieRecord, ULong> BASED_ASCC_ID = createField("based_ascc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "The BASED_ASCC_ID column refers to the ASCC record, which this ASBIE contextualizes.");
     ...
     */
    public final TableField<AsbieRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "Definition to override the ASCC definition. If NULL, it means that the definition should be derived from the based CC on the UI, expression generation, and any API.");
     ...
     */
    public final TableField<AsbieRecord, Integer> CARDINALITY_MIN = createField("cardinality_min", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Minimum occurence constraint of the TO_ASBIEP_ID. A valid value is a non-negative integer.");
     ...
     */
    public final TableField<AsbieRecord, Integer> CARDINALITY_MAX = createField("cardinality_max", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "Maximum occurrence constraint of the TO_ASBIEP_ID. A valid value is an integer from -1 and up. Specifically, -1 means unbounded. 0 means prohibited or not to use.");

    /**
     * The column <code>oagi.asbie.is_nillable</code>. Indicate whether the TO_ASBIEP_ID is allowed to be null.
     */
    public final TableField<AsbieRecord, Byte> IS_NILLABLE = createField("is_nillable", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "Indicate whether the TO_ASBIEP_ID is allowed to be null.");
     ...
     */
    public final TableField<AsbieRecord, String> REMARK = createField("remark", org.jooq.impl.SQLDataType.VARCHAR(225), this, "This column allows the user to specify very context-specific usage of the BIE. It is different from the DEFINITION column in that the DEFINITION column is a description conveying the meaning of the associated concept. Remarks may be a very implementation specific instruction or others. For example, BOM BOD, as an ACC, is a generic BOM structure. In a particular context, a BOM ABIE can be a Super BOM. Explanation of the Super BOM concept should be captured in the Definition of the ABIE. A remark about that ABIE may be \"Type of BOM should be recognized in the BOM/typeCode.\"");
     ...
     */
    public final TableField<AsbieRecord, ULong> LAST_UPDATED_BY = createField("last_updated_by", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "A foreign key referring to the user who has last updated the ASBIE record. ");
     ...
     */
    public final TableField<AsbieRecord, Timestamp> CREATION_TIMESTAMP = createField("creation_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "Timestamp when the ASBIE record was first created. ASBIEs created as children of another ABIE have the same CREATION_TIMESTAMP.");

    /**
     * The column <code>oagi.asbie.last_update_timestamp</code>. The timestamp when the ASBIE was last updated.
     */
    public final TableField<AsbieRecord, Timestamp> LAST_UPDATE_TIMESTAMP = createField("last_update_timestamp", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "The timestamp when the ASBIE was last updated.");
     ...
     */
    public final TableField<AsbieRecord, ULong> OWNER_TOP_LEVEL_ABIE_ID = createField("owner_top_level_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "This is a foriegn key to the ABIE table. It specifies the top-level ABIE which owns this ASBIE record.");
