...
public class CtxSchemeValue extends TableImpl<CtxSchemeValueRecord> {
    ...
    private static final long serialVersionUID = 2061454425;
     ...
     */
    public final TableField<CtxSchemeValueRecord, ULong> CTX_SCHEME_VALUE_ID = createField("ctx_scheme_value_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary, internal database key.");
     ...
     */
    public final TableField<CtxSchemeValueRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR(41).nullable(false), this, "GUID of the context scheme value. Per OAGIS, a GUID is of the form \"oagis-id-\" followed by a 32 Hex character sequence.");

    /**
     * The column <code>oagi.ctx_scheme_value.value</code>. A short value for the scheme value similar to the code list value.
     */
    public final TableField<CtxSchemeValueRecord, String> VALUE = createField("value", org.jooq.impl.SQLDataType.VARCHAR(45).nullable(false), this, "A short value for the scheme value similar to the code list value.");

    /**
     * The column <code>oagi.ctx_scheme_value.meaning</code>. The description, explanatiion of the scheme value.
     */
    public final TableField<CtxSchemeValueRecord, String> MEANING = createField("meaning", org.jooq.impl.SQLDataType.CLOB, this, "The description, explanatiion of the scheme value.");
     ...
     */
    public final TableField<CtxSchemeValueRecord, ULong> OWNER_CTX_SCHEME_ID = createField("owner_ctx_scheme_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the CTX_SCHEME table. It identifies the context scheme, to which this scheme value belongs.");
