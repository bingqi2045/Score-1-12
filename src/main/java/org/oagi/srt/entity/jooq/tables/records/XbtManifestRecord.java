...
public class XbtManifestRecord extends UpdatableRecordImpl<XbtManifestRecord> implements Record7<ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = 1362338271;
    ...
    @Override
    public XbtManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public XbtManifestRecord(ULong xbtManifestId, ULong releaseId, ULong moduleId, ULong xbtId, ULong revisionId, ULong prevXbtManifestId, ULong nextXbtManifestId) {
        super(XbtManifest.XBT_MANIFEST);
