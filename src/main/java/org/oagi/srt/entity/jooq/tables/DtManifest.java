...
public class DtManifest extends TableImpl<DtManifestRecord> {
    ...
    private static final long serialVersionUID = -1625105910;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DT_MANIFEST_DT_MANIFEST_DT_ID_FK, Indexes.DT_MANIFEST_DT_MANIFEST_MODULE_ID_FK, Indexes.DT_MANIFEST_DT_MANIFEST_RELEASE_ID_FK, Indexes.DT_MANIFEST_PRIMARY);
    }
