...
public class DtUsageRule extends TableImpl<DtUsageRuleRecord> {
    ...
    private static final long serialVersionUID = -1160410366;
     ...
     */
    public final TableField<DtUsageRuleRecord, ULong> DT_USAGE_RULE_ID = createField("dt_usage_rule_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary key of the table.");
     ...
     */
    public final TableField<DtUsageRuleRecord, ULong> ASSIGNED_USAGE_RULE_ID = createField("assigned_usage_rule_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the USAGE_RULE table indicating the usage rule assigned to the DT content component or DT_SC.");
     ...
     */
    public final TableField<DtUsageRuleRecord, ULong> TARGET_DT_ID = createField("target_dt_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreing key to the DT_ID for assigning a usage rule to the corresponding DT content component.");
     ...
     */
    public final TableField<DtUsageRuleRecord, ULong> TARGET_DT_SC_ID = createField("target_dt_sc_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreing key to the DT_SC_ID for assigning a usage rule to the corresponding DT_SC.");
