...
public class BccpManifestRecord extends UpdatableRecordImpl<BccpManifestRecord> implements Record5<ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = -207377656;
    ...
    @Override
    public BccpManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BccpManifestRecord(ULong bccpManifestId, ULong releaseId, ULong moduleId, ULong bccpId, ULong bdtManifestId) {
        super(BccpManifest.BCCP_MANIFEST);
