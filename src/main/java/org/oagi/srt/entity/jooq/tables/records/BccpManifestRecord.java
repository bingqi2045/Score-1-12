...
public class BccpManifestRecord extends UpdatableRecordImpl<BccpManifestRecord> implements Record9<ULong, ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {

    private static final long serialVersionUID = -1206464745;
    ...
    @Override
    public BccpManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, Byte value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BccpManifestRecord(ULong bccpManifestId, ULong releaseId, ULong moduleId, ULong bccpId, ULong bdtManifestId, Byte conflict, ULong revisionId, ULong prevBccpManifestId, ULong nextBccpManifestId) {
        super(BccpManifest.BCCP_MANIFEST);
