...
public class BizCtxValue extends TableImpl<BizCtxValueRecord> {
    ...
    private static final long serialVersionUID = 156391558;
     ...
     */
    public final TableField<BizCtxValueRecord, ULong> BIZ_CTX_VALUE_ID = createField("biz_ctx_value_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary, internal database key.");

    /**
     * The column <code>oagi.biz_ctx_value.biz_ctx_id</code>. Foreign key to the biz_ctx table.
     */
    public final TableField<BizCtxValueRecord, ULong> BIZ_CTX_ID = createField("biz_ctx_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the biz_ctx table.");

    /**
     * The column <code>oagi.biz_ctx_value.ctx_scheme_value_id</code>. Foreign key to the CTX_SCHEME_VALUE table.
     */
    public final TableField<BizCtxValueRecord, ULong> CTX_SCHEME_VALUE_ID = createField("ctx_scheme_value_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the CTX_SCHEME_VALUE table.");
