...
public class AsccpManifest extends TableImpl<AsccpManifestRecord> {
    ...
    private static final long serialVersionUID = 1444777939;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ASCCP_MANIFEST_ASCCP_MANIFEST_ASCCP_ID_FK, Indexes.ASCCP_MANIFEST_ASCCP_MANIFEST_MODULE_ID_FK, Indexes.ASCCP_MANIFEST_ASCCP_MANIFEST_RELEASE_ID_FK, Indexes.ASCCP_MANIFEST_ASCCP_MANIFEST_ROLE_OF_ACC_MANIFEST_ID_FK, Indexes.ASCCP_MANIFEST_PRIMARY);
    }
