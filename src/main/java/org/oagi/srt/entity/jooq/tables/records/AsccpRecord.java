...
public class AsccpRecord extends UpdatableRecordImpl<AsccpRecord> implements Record21<ULong, String, String, String, String, ULong, String, ULong, ULong, ULong, Timestamp, Timestamp, Integer, ULong, ULong, Byte, Byte, Integer, Integer, Byte, Byte> {

    private static final long serialVersionUID = 1015507906;
...
State change can't be undone. But the history record can still keep the records of when the state was changed.
    ...
    @Override
    public Row21<ULong, String, String, String, String, ULong, String, ULong, ULong, ULong, Timestamp, Timestamp, Integer, ULong, ULong, Byte, Byte, Integer, Integer, Byte, Byte> valuesRow() {
    ...
    @Override
    public AsccpRecord value19(Integer value) {
