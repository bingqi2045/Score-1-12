...
public class BieUsageRule extends TableImpl<BieUsageRuleRecord> {
    ...
    private static final long serialVersionUID = -1493692696;
     ...
     */
    public final TableField<BieUsageRuleRecord, ULong> BIE_USAGE_RULE_ID = createField("bie_usage_rule_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary key of the table.");
     ...
     */
    public final TableField<BieUsageRuleRecord, ULong> ASSIGNED_USAGE_RULE_ID = createField("assigned_usage_rule_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "Foreign key to the USAGE_RULE table indicating the usage rule assigned to a BIE.");
     ...
     */
    public final TableField<BieUsageRuleRecord, ULong> TARGET_ABIE_ID = createField("target_abie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the ABIE table indicating the ABIE, to which the usage rule is applied.");
     ...
     */
    public final TableField<BieUsageRuleRecord, ULong> TARGET_ASBIE_ID = createField("target_asbie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the ASBIE table indicating the ASBIE, to which the usage rule is applied.");
     ...
     */
    public final TableField<BieUsageRuleRecord, ULong> TARGET_ASBIEP_ID = createField("target_asbiep_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the ASBIEP table indicating the ASBIEP, to which the usage rule is applied.");
     ...
     */
    public final TableField<BieUsageRuleRecord, ULong> TARGET_BBIE_ID = createField("target_bbie_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the BBIE table indicating the BBIE, to which the usage rule is applied.");
     ...
     */
    public final TableField<BieUsageRuleRecord, ULong> TARGET_BBIEP_ID = createField("target_bbiep_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the BBIEP table indicating the ABIEP, to which the usage rule is applied.");
