...
public class AsccpManifestRecord extends UpdatableRecordImpl<AsccpManifestRecord> implements Record8<ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = 808427916;
    ...
    @Override
    public AsccpManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AsccpManifestRecord(ULong asccpManifestId, ULong releaseId, ULong moduleId, ULong asccpId, ULong roleOfAccManifestId, ULong revisionId, ULong prevAsccpManifestId, ULong nextAsccpManifestId) {
        super(AsccpManifest.ASCCP_MANIFEST);
