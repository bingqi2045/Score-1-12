...
public class TopLevelAbieRecord extends UpdatableRecordImpl<TopLevelAbieRecord> implements Record6<ULong, ULong, ULong, Timestamp, ULong, Integer> {

    private static final long serialVersionUID = -1503008306;
     ...
     */
    @Override
    public Row6<ULong, ULong, ULong, Timestamp, ULong, Integer> valuesRow() {
     ...
     */
    @Override
    public TopLevelAbieRecord value6(Integer value) {
        setState(value);
        return this;
    }
     ...
     */
    @Override
    public TopLevelAbieRecord values(ULong value1, ULong value2, ULong value3, Timestamp value4, ULong value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TopLevelAbieRecord(ULong topLevelAbieId, ULong abieId, ULong ownerUserId, Timestamp lastUpdateTimestamp, ULong releaseId, Integer state) {
        super(TopLevelAbie.TOP_LEVEL_ABIE);
