...
public class BccpManifest extends TableImpl<BccpManifestRecord> {
    ...
    private static final long serialVersionUID = -1481441730;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BCCP_MANIFEST_BCCP_MANIFEST_BCCP_ID_FK, Indexes.BCCP_MANIFEST_BCCP_MANIFEST_BDT_MANIFEST_ID_FK, Indexes.BCCP_MANIFEST_BCCP_MANIFEST_MODULE_ID_FK, Indexes.BCCP_MANIFEST_BCCP_MANIFEST_RELEASE_ID_FK, Indexes.BCCP_MANIFEST_PRIMARY);
    }
    ...
    public List<ForeignKey<BccpManifestRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<BccpManifestRecord, ?>>asList(Keys.BCCP_MANIFEST_RELEASE_ID_FK, Keys.BCCP_MANIFEST_MODULE_ID_FK, Keys.BCCP_MANIFEST_BCCP_ID_FK, Keys.BCCP_MANIFEST_BDT_MANIFEST_ID_FK);
    }
