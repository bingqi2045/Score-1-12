...
public class AgencyIdList extends TableImpl<AgencyIdListRecord> {
    ...
    private static final long serialVersionUID = 1998302115;
     ...
     */
    public final TableField<AgencyIdListRecord, ULong> AGENCY_ID_LIST_ID = createField("agency_id_list_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "A internal, primary database key.");
     ...
     */
    public final TableField<AgencyIdListRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR(41), this, "A globally unique identifier (GUID) of an agency identifier scheme. Per OAGIS, a GUID is of the form \"oagis-id-\" followed by a 32 Hex character sequence.");
     ...
     */
    public final TableField<AgencyIdListRecord, String> ENUM_TYPE_GUID = createField("enum_type_guid", org.jooq.impl.SQLDataType.VARCHAR(41).nullable(false), this, "This column stores the GUID of the type containing the enumerated values. In OAGIS, most code lists and agnecy ID lists are defined by an XyzCodeContentType (or XyzAgencyIdentificationContentType) and XyzCodeEnumerationType (or XyzAgencyIdentificationEnumerationContentType). However, some don't have the enumeration type. When that is the case, this column is null.");

    /**
     * The column <code>oagi.agency_id_list.name</code>. Name of the agency identification list.
     */
    public final TableField<AgencyIdListRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(100), this, "Name of the agency identification list.");
     ...
     */
    public final TableField<AgencyIdListRecord, String> LIST_ID = createField("list_id", org.jooq.impl.SQLDataType.VARCHAR(10), this, "This is a business or standard identification assigned to the agency identification list.");
     ...
     */
    public final TableField<AgencyIdListRecord, String> VERSION_ID = createField("version_id", org.jooq.impl.SQLDataType.VARCHAR(10), this, "Version number of the agency identification list (assigned by the agency).");
     ...
     */
    public final TableField<AgencyIdListRecord, ULong> MODULE_ID = createField("module_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, this, "Foreign key to the module table indicating the physical schema the MODULE belongs to.");

    /**
     * The column <code>oagi.agency_id_list.definition</code>. Description of the agency identification list.
     */
    public final TableField<AgencyIdListRecord, String> DEFINITION = createField("definition", org.jooq.impl.SQLDataType.CLOB, this, "Description of the agency identification list.");
