...
public class CodeListManifestRecord extends UpdatableRecordImpl<CodeListManifestRecord> implements Record9<ULong, ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {

    private static final long serialVersionUID = 234571827;
    ...
    @Override
    public CodeListManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, Byte value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CodeListManifestRecord(ULong codeListManifestId, ULong releaseId, ULong moduleId, ULong codeListId, ULong basedCodeListManifestId, Byte conflict, ULong revisionId, ULong prevCodeListManifestId, ULong nextCodeListManifestId) {
        super(CodeListManifest.CODE_LIST_MANIFEST);
