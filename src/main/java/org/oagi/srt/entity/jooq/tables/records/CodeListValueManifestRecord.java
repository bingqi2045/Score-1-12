...
public class CodeListValueManifestRecord extends UpdatableRecordImpl<CodeListValueManifestRecord> implements Record7<ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = -1268833571;
    ...
    /**
     * Setter for <code>oagi.code_list_value_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    /**
     * Getter for <code>oagi.code_list_value_manifest.revision_id</code>. A foreign key pointed to revision for the current record.
     */
    ...
    public Field<ULong> field5() {
        return CodeListValueManifest.CODE_LIST_VALUE_MANIFEST.REVISION_ID;
    }
    ...
    @Override
    public CodeListValueManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CodeListValueManifestRecord(ULong codeListValueManifestId, ULong releaseId, ULong codeListValueId, ULong codeListManifestId, ULong revisionId, ULong prevCodeListValueManifestId, ULong nextCodeListValueManifestId) {
        super(CodeListValueManifest.CODE_LIST_VALUE_MANIFEST);
