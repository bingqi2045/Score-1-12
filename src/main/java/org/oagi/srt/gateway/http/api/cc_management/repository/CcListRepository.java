...
public class CcListRepository {
    ...
    public List<CcList> getAccCcList(long releaseId) {
        List<CcList> ccLists =
                jdbcTemplate.queryForList("SELECT 'acc' as type, acc_id as id, guid, den, u1.login_id as owner, state, is_deprecated as deprecated, " +
    ...
    public List<CcList> getAsccpCcList(long releaseId) {
        List<CcList> ccLists =
                jdbcTemplate.queryForList("SELECT 'asccp' as type, asccp_id as id, guid, den, u1.login_id as owner, state, is_deprecated as deprecated, " +
                        "revision_num, revision_tracking_num, revision_action, release_id, " +
    ...
    public List<CcList> getBccpCcList(long releaseId) {
        List<CcList> ccLists =
                jdbcTemplate.queryForList("SELECT 'bccp' as type, bccp_id as id, guid, den, u1.login_id as owner, state, is_deprecated as deprecated, " +
                        "revision_num, revision_tracking_num, revision_action, release_id, " +
    ...
    public List<CcList> getAsccCcList(long releaseId) {
        List<CcList> ccLists =
                jdbcTemplate.queryForList("SELECT 'ascc' as type, ascc_id as id, guid, den, u1.login_id as owner, state, is_deprecated as deprecated, " +
                        "revision_num, revision_tracking_num, revision_action, release_id, " +
    ...
    public List<CcList> getBccCcList(long releaseId) {
        List<CcList> ccLists =
                jdbcTemplate.queryForList("SELECT 'bcc' as type, bcc_id as id, guid, den, u1.login_id as owner, state, is_deprecated as deprecated, " +
                        "revision_num, revision_tracking_num, revision_action, release_id, " +
