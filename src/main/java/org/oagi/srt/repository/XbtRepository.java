...
public class XbtRepository implements SrtRepository<Xbt> {
    ...
    private SelectOnConditionStep<
            Record20<ULong, ULong, ULong, ULong, String,
                    ULong, ULong, ULong, String, LocalDateTime,
                    Byte, String, String, LocalDateTime, String,
                    String, UInteger, UInteger, String, Integer>> getSelectJoinStep() {
        return dslContext.select(XBT.XBT_ID, XBT.CREATED_BY,
                ...
                XBT.LAST_UPDATE_TIMESTAMP, REVISION.REVISION_ACTION, XBT.REVISION_DOC,
                ...
                .join(REVISION)
                .on(XBT.REVISION_ID.eq(REVISION.REVISION_ID));
    }
