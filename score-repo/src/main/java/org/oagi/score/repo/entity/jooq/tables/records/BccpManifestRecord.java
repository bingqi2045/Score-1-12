...
public class BccpManifestRecord extends UpdatableRecordImpl<BccpManifestRecord> implements Record8<ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {

    private static final long serialVersionUID = 478086431;
    ...
    @Override
    public BccpManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, Byte value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BccpManifestRecord(ULong bccpManifestId, ULong releaseId, ULong bccpId, ULong bdtManifestId, Byte conflict, ULong revisionId, ULong prevBccpManifestId, ULong nextBccpManifestId) {
        super(BccpManifest.BCCP_MANIFEST);
