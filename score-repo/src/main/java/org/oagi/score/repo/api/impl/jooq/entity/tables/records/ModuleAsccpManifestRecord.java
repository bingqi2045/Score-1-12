...
public class ModuleAsccpManifestRecord extends UpdatableRecordImpl<ModuleAsccpManifestRecord> implements Record8<String, String, ULong, String, String, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public ModuleAsccpManifestRecord values(String value1, String value2, ULong value3, String value4, String value5, String value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModuleAsccpManifestRecord(String moduleAsccpManifestId, String moduleSetReleaseId, ULong asccpManifestId, String moduleId, String createdBy, String lastUpdatedBy, LocalDateTime creationTimestamp, LocalDateTime lastUpdateTimestamp) {
        super(ModuleAsccpManifest.MODULE_ASCCP_MANIFEST);
