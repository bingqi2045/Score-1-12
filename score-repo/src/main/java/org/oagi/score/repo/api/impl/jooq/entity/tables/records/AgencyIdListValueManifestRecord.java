...
public class AgencyIdListValueManifestRecord extends UpdatableRecordImpl<AgencyIdListValueManifestRecord> implements Record9<ULong, String, String, ULong, ULong, Byte, ULong, ULong, ULong> {
    ...
    @Override
    public AgencyIdListValueManifestRecord values(ULong value1, String value2, String value3, ULong value4, ULong value5, Byte value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AgencyIdListValueManifestRecord(ULong agencyIdListValueManifestId, String releaseId, String agencyIdListValueId, ULong agencyIdListManifestId, ULong basedAgencyIdListValueManifestId, Byte conflict, ULong replacementAgencyIdListValueManifestId, ULong prevAgencyIdListValueManifestId, ULong nextAgencyIdListValueManifestId) {
        super(AgencyIdListValueManifest.AGENCY_ID_LIST_VALUE_MANIFEST);
