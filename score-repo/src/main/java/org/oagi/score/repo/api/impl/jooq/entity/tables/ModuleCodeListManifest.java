...
public class ModuleCodeListManifest extends TableImpl<ModuleCodeListManifestRecord> {
     ...
     */
    public final TableField<ModuleCodeListManifestRecord, String> MODULE_CODE_LIST_MANIFEST_ID = createField(DSL.name("module_code_list_manifest_id"), SQLDataType.CHAR(36).nullable(false), this, "Primary, internal database key.");
     ...
     */
    public final TableField<ModuleCodeListManifestRecord, String> MODULE_SET_RELEASE_ID = createField(DSL.name("module_set_release_id"), SQLDataType.CHAR(36).nullable(false), this, "A foreign key of the module set release record.");
     ...
     */
    public final TableField<ModuleCodeListManifestRecord, String> CODE_LIST_MANIFEST_ID = createField(DSL.name("code_list_manifest_id"), SQLDataType.CHAR(36).nullable(false), this, "A foreign key of the code list manifest record.");

    /**
     * The column <code>oagi.module_code_list_manifest.module_id</code>. This
     * indicates a module.
     */
    public final TableField<ModuleCodeListManifestRecord, String> MODULE_ID = createField(DSL.name("module_id"), SQLDataType.CHAR(36).nullable(false), this, "This indicates a module.");
     ...
     * record.
     */
    public final TableField<ModuleCodeListManifestRecord, String> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.CHAR(36).nullable(false), this, "Foreign key to the APP_USER table. It indicates the user who created this record.");
     ...
     * the record.
     */
    public final TableField<ModuleCodeListManifestRecord, String> LAST_UPDATED_BY = createField(DSL.name("last_updated_by"), SQLDataType.CHAR(36).nullable(false), this, "Foreign key to the APP_USER table referring to the last user who updated the record.");
