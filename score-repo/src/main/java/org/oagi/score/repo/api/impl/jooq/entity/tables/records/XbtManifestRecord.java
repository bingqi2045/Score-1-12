...
public class XbtManifestRecord extends UpdatableRecordImpl<XbtManifestRecord> implements Record7<ULong, ULong, String, Byte, ULong, ULong, ULong> {
    ...
    @Override
    public Row7<ULong, ULong, String, Byte, ULong, ULong, ULong> valuesRow() {
    ...
    @Override
    public XbtManifestRecord values(ULong value1, ULong value2, String value3, Byte value4, ULong value5, ULong value6, ULong value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public XbtManifestRecord(ULong xbtManifestId, ULong releaseId, String xbtId, Byte conflict, ULong logId, ULong prevXbtManifestId, ULong nextXbtManifestId) {
        super(XbtManifest.XBT_MANIFEST);
