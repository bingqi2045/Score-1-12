...
public class TopLevelAbie extends TableImpl<TopLevelAbieRecord> {
    ...
    private static final long serialVersionUID = 191293751;
    ...
    private TopLevelAbie(Name alias, Table<TopLevelAbieRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("This table indexes the ABIE which is a top-level ABIE. This table and the owner_top_level_abie_id column in all BIE tables allow all related BIEs to be retrieved all at once speeding up the profile BOD transactions."), TableOptions.table());
    }
