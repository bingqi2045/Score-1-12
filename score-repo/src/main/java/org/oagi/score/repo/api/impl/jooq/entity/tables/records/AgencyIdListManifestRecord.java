...
public class AgencyIdListManifestRecord extends UpdatableRecordImpl<AgencyIdListManifestRecord> implements Record10<ULong, String, ULong, ULong, ULong, Byte, String, ULong, ULong, ULong> {
    ...
    @Override
    public Row10<ULong, String, ULong, ULong, ULong, Byte, String, ULong, ULong, ULong> valuesRow() {
    ...
    @Override
    public AgencyIdListManifestRecord values(ULong value1, String value2, ULong value3, ULong value4, ULong value5, Byte value6, String value7, ULong value8, ULong value9, ULong value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AgencyIdListManifestRecord(ULong agencyIdListManifestId, String releaseId, ULong agencyIdListId, ULong agencyIdListValueManifestId, ULong basedAgencyIdListManifestId, Byte conflict, String logId, ULong replacementAgencyIdListManifestId, ULong prevAgencyIdListManifestId, ULong nextAgencyIdListManifestId) {
        super(AgencyIdListManifest.AGENCY_ID_LIST_MANIFEST);
