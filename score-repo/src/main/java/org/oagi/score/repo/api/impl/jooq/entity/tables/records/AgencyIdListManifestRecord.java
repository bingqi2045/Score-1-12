...
public class AgencyIdListManifestRecord extends UpdatableRecordImpl<AgencyIdListManifestRecord> implements Record8<ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {

    private static final long serialVersionUID = 1227554218;
    ...
    @Override
    public AgencyIdListManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, Byte value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AgencyIdListManifestRecord(ULong agencyIdListManifestId, ULong releaseId, ULong agencyIdListId, ULong basedAgencyIdListManifestId, Byte conflict, ULong revisionId, ULong prevAgencyIdListManifestId, ULong nextAgencyIdListManifestId) {
        super(AgencyIdListManifest.AGENCY_ID_LIST_MANIFEST);
        ...
        set(4, conflict);
        set(5, revisionId);
        set(6, prevAgencyIdListManifestId);
        set(7, nextAgencyIdListManifestId);
    }
}
