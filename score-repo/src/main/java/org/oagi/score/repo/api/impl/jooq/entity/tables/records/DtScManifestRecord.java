...
public class DtScManifestRecord extends UpdatableRecordImpl<DtScManifestRecord> implements Record9<ULong, ULong, ULong, ULong, Byte, ULong, ULong, ULong, ULong> {
    ...
    @Override
    public DtScManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, Byte value5, ULong value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DtScManifestRecord(ULong dtScManifestId, ULong releaseId, ULong dtScId, ULong ownerDtManifestId, Byte conflict, ULong replacementDtScManifestId, ULong prevDtScManifestId, ULong nextDtScManifestId, ULong basedDtScManifestId) {
        super(DtScManifest.DT_SC_MANIFEST);
