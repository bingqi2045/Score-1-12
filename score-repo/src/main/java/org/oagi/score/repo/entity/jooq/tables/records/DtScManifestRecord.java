...
public class DtScManifestRecord extends UpdatableRecordImpl<DtScManifestRecord> implements Record7<ULong, ULong, ULong, ULong, Byte, ULong, ULong> {
    ...
    private static final long serialVersionUID = 12986477;
    ...
    @Override
    public DtScManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, Byte value5, ULong value6, ULong value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DtScManifestRecord(ULong dtScManifestId, ULong releaseId, ULong dtScId, ULong ownerDtManifestId, Byte conflict, ULong prevDtScManifestId, ULong nextDtScManifestId) {
        super(DtScManifest.DT_SC_MANIFEST);
