...
public class ModuleAccManifestRecord extends UpdatableRecordImpl<ModuleAccManifestRecord> implements Record8<String, String, ULong, String, String, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public ModuleAccManifestRecord values(String value1, String value2, ULong value3, String value4, String value5, String value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModuleAccManifestRecord(String moduleAccManifestId, String moduleSetReleaseId, ULong accManifestId, String moduleId, String createdBy, String lastUpdatedBy, LocalDateTime creationTimestamp, LocalDateTime lastUpdateTimestamp) {
        super(ModuleAccManifest.MODULE_ACC_MANIFEST);
