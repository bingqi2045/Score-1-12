...
public class BccManifestRecord extends UpdatableRecordImpl<BccManifestRecord> implements Record10<ULong, String, String, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {
    ...
    @Override
    public Row10<ULong, String, String, ULong, ULong, ULong, Byte, ULong, ULong, ULong> fieldsRow() {
        return (Row10) super.fieldsRow();
    }

    @Override
    public Row10<ULong, String, String, ULong, ULong, ULong, Byte, ULong, ULong, ULong> valuesRow() {
    ...
    @Override
    public BccManifestRecord values(ULong value1, String value2, String value3, ULong value4, ULong value5, ULong value6, Byte value7, ULong value8, ULong value9, ULong value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BccManifestRecord(ULong bccManifestId, String releaseId, String bccId, ULong seqKeyId, ULong fromAccManifestId, ULong toBccpManifestId, Byte conflict, ULong replacementBccManifestId, ULong prevBccManifestId, ULong nextBccManifestId) {
        super(BccManifest.BCC_MANIFEST);
