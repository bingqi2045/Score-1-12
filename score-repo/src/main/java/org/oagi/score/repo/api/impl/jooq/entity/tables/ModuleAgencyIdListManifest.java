...
public class ModuleAgencyIdListManifest extends TableImpl<ModuleAgencyIdListManifestRecord> {
     ...
     */
    public final TableField<ModuleAgencyIdListManifestRecord, String> MODULE_AGENCY_ID_LIST_MANIFEST_ID = createField(DSL.name("module_agency_id_list_manifest_id"), SQLDataType.CHAR(36).nullable(false), this, "Primary, internal database key.");
     ...
     */
    public final TableField<ModuleAgencyIdListManifestRecord, String> MODULE_SET_RELEASE_ID = createField(DSL.name("module_set_release_id"), SQLDataType.CHAR(36).nullable(false), this, "A foreign key of the module set release record.");
     ...
     */
    public final TableField<ModuleAgencyIdListManifestRecord, String> AGENCY_ID_LIST_MANIFEST_ID = createField(DSL.name("agency_id_list_manifest_id"), SQLDataType.CHAR(36).nullable(false), this, "A foreign key of the code list manifest record.");

    /**
     * The column <code>oagi.module_agency_id_list_manifest.module_id</code>.
     * This indicates a module.
     */
    public final TableField<ModuleAgencyIdListManifestRecord, String> MODULE_ID = createField(DSL.name("module_id"), SQLDataType.CHAR(36).nullable(false), this, "This indicates a module.");
     ...
     * record.
     */
    public final TableField<ModuleAgencyIdListManifestRecord, String> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.CHAR(36).nullable(false), this, "Foreign key to the APP_USER table. It indicates the user who created this record.");
     ...
     * record.
     */
    public final TableField<ModuleAgencyIdListManifestRecord, String> LAST_UPDATED_BY = createField(DSL.name("last_updated_by"), SQLDataType.CHAR(36).nullable(false), this, "Foreign key to the APP_USER table referring to the last user who updated the record.");
