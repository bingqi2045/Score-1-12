...
public class BccpManifestRecord extends UpdatableRecordImpl<BccpManifestRecord> implements Record9<ULong, String, String, ULong, Byte, String, ULong, ULong, ULong> {
    ...
    @Override
    public BccpManifestRecord values(ULong value1, String value2, String value3, ULong value4, Byte value5, String value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BccpManifestRecord(ULong bccpManifestId, String releaseId, String bccpId, ULong bdtManifestId, Byte conflict, String logId, ULong replacementBccpManifestId, ULong prevBccpManifestId, ULong nextBccpManifestId) {
        super(BccpManifest.BCCP_MANIFEST);
