...
public class ModuleXbtManifest extends TableImpl<ModuleXbtManifestRecord> {
     ...
     */
    public final TableField<ModuleXbtManifestRecord, String> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.CHAR(36).nullable(false), this, "Foreign key to the APP_USER table. It indicates the user who created this record.");
     ...
     * record.
     */
    public final TableField<ModuleXbtManifestRecord, String> LAST_UPDATED_BY = createField(DSL.name("last_updated_by"), SQLDataType.CHAR(36).nullable(false), this, "Foreign key to the APP_USER table referring to the last user who updated the record.");
