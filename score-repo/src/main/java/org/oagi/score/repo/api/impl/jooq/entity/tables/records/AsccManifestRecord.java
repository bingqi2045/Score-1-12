...
public class AsccManifestRecord extends UpdatableRecordImpl<AsccManifestRecord> implements Record10<ULong, String, String, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {
    ...
    @Override
    public AsccManifestRecord values(ULong value1, String value2, String value3, ULong value4, ULong value5, ULong value6, Byte value7, ULong value8, ULong value9, ULong value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AsccManifestRecord(ULong asccManifestId, String releaseId, String asccId, ULong seqKeyId, ULong fromAccManifestId, ULong toAsccpManifestId, Byte conflict, ULong replacementAsccManifestId, ULong prevAsccManifestId, ULong nextAsccManifestId) {
        super(AsccManifest.ASCC_MANIFEST);
