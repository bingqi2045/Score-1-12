...
public class ModuleDtManifestRecord extends UpdatableRecordImpl<ModuleDtManifestRecord> implements Record8<ULong, ULong, ULong, ULong, String, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public ModuleDtManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, String value5, String value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModuleDtManifestRecord(ULong moduleDtManifestId, ULong moduleSetReleaseId, ULong dtManifestId, ULong moduleId, String createdBy, String lastUpdatedBy, LocalDateTime creationTimestamp, LocalDateTime lastUpdateTimestamp) {
        super(ModuleDtManifest.MODULE_DT_MANIFEST);
