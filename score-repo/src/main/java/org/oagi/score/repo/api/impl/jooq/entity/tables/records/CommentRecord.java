...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record9<ULong, String, String, Byte, Byte, ULong, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row9<ULong, String, String, Byte, Byte, ULong, String, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public CommentRecord values(ULong value1, String value2, String value3, Byte value4, Byte value5, ULong value6, String value7, LocalDateTime value8, LocalDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(ULong commentId, String reference, String comment, Byte isHidden, Byte isDeleted, ULong prevCommentId, String createdBy, LocalDateTime creationTimestamp, LocalDateTime lastUpdateTimestamp) {
        super(Comment.COMMENT);
