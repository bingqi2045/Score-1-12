...
public class ExceptionRecord extends UpdatableRecordImpl<ExceptionRecord> implements Record6<ULong, String, String, byte[], String, LocalDateTime> {
    ...
    @Override
    public Row6<ULong, String, String, byte[], String, LocalDateTime> valuesRow() {
    ...
    @Override
    public ExceptionRecord values(ULong value1, String value2, String value3, byte[] value4, String value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExceptionRecord(ULong exceptionId, String tag, String message, byte[] stacktrace, String createdBy, LocalDateTime creationTimestamp) {
        super(Exception.EXCEPTION);
