...
public class ExceptionRecord extends UpdatableRecordImpl<ExceptionRecord> implements Record6<String, String, String, byte[], String, LocalDateTime> {

    private static final long serialVersionUID = 1L;

    /**
     * Setter for <code>oagi.exception.exception_id</code>. Primary, internal
     * database key.
     */
    ...
    /**
     * Getter for <code>oagi.exception.exception_id</code>. Primary, internal
     * database key.
     */
    ...
    @Override
    public Row6<String, String, String, byte[], String, LocalDateTime> valuesRow() {
    ...
    @Override
    public ExceptionRecord value1(String value) {
    ...
    @Override
    public ExceptionRecord value5(String value) {
        setCreatedBy(value);
        return this;
    }
    ...
    @Override
    public ExceptionRecord values(String value1, String value2, String value3, byte[] value4, String value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExceptionRecord(String exceptionId, String tag, String message, byte[] stacktrace, String createdBy, LocalDateTime creationTimestamp) {
        super(Exception.EXCEPTION);
