...
public class CdtScRefSpecRecord extends UpdatableRecordImpl<CdtScRefSpecRecord> implements Record3<ULong, String, ULong> {
    ...
    @Override
    public CdtScRefSpecRecord values(ULong value1, String value2, ULong value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public CdtScRefSpecRecord(ULong cdtScRefSpecId, String cdtScId, ULong refSpecId) {
        super(CdtScRefSpec.CDT_SC_REF_SPEC);
