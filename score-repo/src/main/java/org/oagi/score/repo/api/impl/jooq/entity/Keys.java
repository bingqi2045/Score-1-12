...
public class Keys {
    ...
    public static final ForeignKey<ModuleAccManifestRecord, ModuleRecord> MODULE_ACC_MANIFEST_MODULE_ID_FK = ForeignKeys0.MODULE_ACC_MANIFEST_MODULE_ID_FK;
    ...
    public static final ForeignKey<ModuleAgencyIdListManifestRecord, ModuleRecord> MODULE_AGENCY_ID_LIST_MANIFEST_MODULE_ID_FK = ForeignKeys0.MODULE_AGENCY_ID_LIST_MANIFEST_MODULE_ID_FK;
    ...
    public static final ForeignKey<ModuleAsccpManifestRecord, ModuleRecord> MODULE_ASCCP_MANIFEST_MODULE_ID_FK = ForeignKeys0.MODULE_ASCCP_MANIFEST_MODULE_ID_FK;
    ...
    public static final ForeignKey<ModuleDtManifestRecord, ModuleRecord> MODULE_DT_MANIFEST_MODULE_ID_FK = ForeignKeys0.MODULE_DT_MANIFEST_MODULE_ID_FK;
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<ModuleAccManifestRecord, ModuleRecord> MODULE_ACC_MANIFEST_MODULE_ID_FK = Internal.createForeignKey(Keys.KEY_MODULE_PRIMARY, ModuleAccManifest.MODULE_ACC_MANIFEST, "module_acc_manifest_module_id_fk", new TableField[] { ModuleAccManifest.MODULE_ACC_MANIFEST.MODULE_ID }, true);
        ...
        public static final ForeignKey<ModuleAgencyIdListManifestRecord, ModuleRecord> MODULE_AGENCY_ID_LIST_MANIFEST_MODULE_ID_FK = Internal.createForeignKey(Keys.KEY_MODULE_PRIMARY, ModuleAgencyIdListManifest.MODULE_AGENCY_ID_LIST_MANIFEST, "module_agency_id_list_manifest_module_id_fk", new TableField[] { ModuleAgencyIdListManifest.MODULE_AGENCY_ID_LIST_MANIFEST.MODULE_ID }, true);
        ...
        public static final ForeignKey<ModuleAsccpManifestRecord, ModuleRecord> MODULE_ASCCP_MANIFEST_MODULE_ID_FK = Internal.createForeignKey(Keys.KEY_MODULE_PRIMARY, ModuleAsccpManifest.MODULE_ASCCP_MANIFEST, "module_asccp_manifest_module_id_fk", new TableField[] { ModuleAsccpManifest.MODULE_ASCCP_MANIFEST.MODULE_ID }, true);
        ...
        public static final ForeignKey<ModuleDtManifestRecord, ModuleRecord> MODULE_DT_MANIFEST_MODULE_ID_FK = Internal.createForeignKey(Keys.KEY_MODULE_PRIMARY, ModuleDtManifest.MODULE_DT_MANIFEST, "module_dt_manifest_module_id_fk", new TableField[] { ModuleDtManifest.MODULE_DT_MANIFEST.MODULE_ID }, true);
