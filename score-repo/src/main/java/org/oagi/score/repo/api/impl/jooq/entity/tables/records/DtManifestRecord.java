...
public class DtManifestRecord extends UpdatableRecordImpl<DtManifestRecord> implements Record9<ULong, String, ULong, ULong, Byte, String, ULong, ULong, ULong> {
    ...
    @Override
    public DtManifestRecord values(ULong value1, String value2, ULong value3, ULong value4, Byte value5, String value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DtManifestRecord(ULong dtManifestId, String releaseId, ULong dtId, ULong basedDtManifestId, Byte conflict, String logId, ULong replacementDtManifestId, ULong prevDtManifestId, ULong nextDtManifestId) {
        super(DtManifest.DT_MANIFEST);
