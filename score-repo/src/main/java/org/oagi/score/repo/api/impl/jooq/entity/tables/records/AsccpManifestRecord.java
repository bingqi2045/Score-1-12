...
public class AsccpManifestRecord extends UpdatableRecordImpl<AsccpManifestRecord> implements Record9<ULong, String, String, ULong, Byte, String, ULong, ULong, ULong> {
    ...
    @Override
    public AsccpManifestRecord values(ULong value1, String value2, String value3, ULong value4, Byte value5, String value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AsccpManifestRecord(ULong asccpManifestId, String releaseId, String asccpId, ULong roleOfAccManifestId, Byte conflict, String logId, ULong replacementAsccpManifestId, ULong prevAsccpManifestId, ULong nextAsccpManifestId) {
        super(AsccpManifest.ASCCP_MANIFEST);
