...
public class Bbie extends TableImpl<BbieRecord> {
    ...
    private static final long serialVersionUID = 1997568425;
     ...
     */
    public final TableField<BbieRecord, LocalDateTime> CREATION_TIMESTAMP = createField(DSL.name("creation_timestamp"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false), this, "Timestamp when the BBIE record was first created. BBIEs created as children of another ABIE have the same CREATION_TIMESTAMP.");

    /**
     * The column <code>oagi.bbie.last_update_timestamp</code>. The timestamp when the ASBIE was last updated.
     */
    public final TableField<BbieRecord, LocalDateTime> LAST_UPDATE_TIMESTAMP = createField(DSL.name("last_update_timestamp"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false), this, "The timestamp when the ASBIE was last updated.");
