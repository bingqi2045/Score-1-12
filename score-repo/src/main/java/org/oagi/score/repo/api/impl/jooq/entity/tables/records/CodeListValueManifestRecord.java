...
public class CodeListValueManifestRecord extends UpdatableRecordImpl<CodeListValueManifestRecord> implements Record9<ULong, String, ULong, ULong, ULong, Byte, ULong, ULong, ULong> {
    ...
    @Override
    public CodeListValueManifestRecord values(ULong value1, String value2, ULong value3, ULong value4, ULong value5, Byte value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CodeListValueManifestRecord(ULong codeListValueManifestId, String releaseId, ULong codeListValueId, ULong codeListManifestId, ULong basedCodeListValueManifestId, Byte conflict, ULong replacementCodeListValueManifestId, ULong prevCodeListValueManifestId, ULong nextCodeListValueManifestId) {
        super(CodeListValueManifest.CODE_LIST_VALUE_MANIFEST);
