...
public class CodeListManifestRecord extends UpdatableRecordImpl<CodeListManifestRecord> implements Record10<ULong, String, ULong, ULong, ULong, Byte, String, ULong, ULong, ULong> {
    ...
    @Override
    public CodeListManifestRecord values(ULong value1, String value2, ULong value3, ULong value4, ULong value5, Byte value6, String value7, ULong value8, ULong value9, ULong value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CodeListManifestRecord(ULong codeListManifestId, String releaseId, ULong codeListId, ULong basedCodeListManifestId, ULong agencyIdListValueManifestId, Byte conflict, String logId, ULong replacementCodeListManifestId, ULong prevCodeListManifestId, ULong nextCodeListManifestId) {
        super(CodeListManifest.CODE_LIST_MANIFEST);
