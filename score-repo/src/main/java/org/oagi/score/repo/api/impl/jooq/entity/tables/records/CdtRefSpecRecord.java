...
public class CdtRefSpecRecord extends UpdatableRecordImpl<CdtRefSpecRecord> implements Record3<ULong, String, ULong> {
    ...
    @Override
    public CdtRefSpecRecord values(ULong value1, String value2, ULong value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public CdtRefSpecRecord(ULong cdtRefSpecId, String cdtId, ULong refSpecId) {
        super(CdtRefSpec.CDT_REF_SPEC);
