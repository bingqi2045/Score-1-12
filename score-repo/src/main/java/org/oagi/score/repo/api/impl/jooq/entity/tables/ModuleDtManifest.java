...
public class ModuleDtManifest extends TableImpl<ModuleDtManifestRecord> {
     ...
     */
    public final TableField<ModuleDtManifestRecord, String> MODULE_DT_MANIFEST_ID = createField(DSL.name("module_dt_manifest_id"), SQLDataType.CHAR(36).nullable(false), this, "Primary, internal database key.");

    /**
     * The column <code>oagi.module_dt_manifest.module_set_release_id</code>. A
     * foreign key of the module set release record.
     */
    public final TableField<ModuleDtManifestRecord, String> MODULE_SET_RELEASE_ID = createField(DSL.name("module_set_release_id"), SQLDataType.CHAR(36).nullable(false), this, "A foreign key of the module set release record.");

    /**
     * The column <code>oagi.module_dt_manifest.dt_manifest_id</code>. A foreign
     * key of the dt manifest record.
     */
    public final TableField<ModuleDtManifestRecord, String> DT_MANIFEST_ID = createField(DSL.name("dt_manifest_id"), SQLDataType.CHAR(36).nullable(false), this, "A foreign key of the dt manifest record.");

    /**
     * The column <code>oagi.module_dt_manifest.module_id</code>. This indicates
     * a module.
     */
    public final TableField<ModuleDtManifestRecord, String> MODULE_ID = createField(DSL.name("module_id"), SQLDataType.CHAR(36).nullable(false), this, "This indicates a module.");
