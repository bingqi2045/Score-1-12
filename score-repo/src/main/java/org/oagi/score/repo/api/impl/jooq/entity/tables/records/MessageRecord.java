...
public class MessageRecord extends UpdatableRecordImpl<MessageRecord> implements Record8<String, String, String, String, String, String, Byte, LocalDateTime> {

    private static final long serialVersionUID = 1L;

    /**
     * Setter for <code>oagi.message.message_id</code>. Primary, internal
     * database key.
     */
    ...
    /**
     * Getter for <code>oagi.message.message_id</code>. Primary, internal
     * database key.
     */
    ...
    @Override
    public Row8<String, String, String, String, String, String, Byte, LocalDateTime> valuesRow() {
    ...
    @Override
    public MessageRecord values(String value1, String value2, String value3, String value4, String value5, String value6, Byte value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageRecord(String messageId, String senderId, String recipientId, String subject, String body, String bodyContentType, Byte isRead, LocalDateTime creationTimestamp) {
        super(Message.MESSAGE);
