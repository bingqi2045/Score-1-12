...
public class MessageRecord extends UpdatableRecordImpl<MessageRecord> implements Record7<ULong, ULong, ULong, String, String, Byte, LocalDateTime> {
    ...
    @Override
    public Row7<ULong, ULong, ULong, String, String, Byte, LocalDateTime> valuesRow() {
    ...
    @Override
    public MessageRecord values(ULong value1, ULong value2, ULong value3, String value4, String value5, Byte value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageRecord(ULong messageId, ULong senderId, ULong recipientId, String body, String bodyContentType, Byte isRead, LocalDateTime creationTimestamp) {
        super(Message.MESSAGE);
