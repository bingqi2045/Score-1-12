...
public class ModuleBlobContentManifestRecord extends UpdatableRecordImpl<ModuleBlobContentManifestRecord> implements Record8<String, String, String, String, String, String, LocalDateTime, LocalDateTime> {
     ...
     */
    public void setModuleBlobContentManifestId(String value) {
        set(0, value);
    }
     ...
     * Primary, internal database key.
     */
    public String getModuleBlobContentManifestId() {
        return (String) get(0);
    }
    ...
    @Override
    public ModuleBlobContentManifestRecord value1(String value) {
        setModuleBlobContentManifestId(value);
        return this;
    }

    @Override
    public ModuleBlobContentManifestRecord value2(String value) {
        setModuleSetReleaseId(value);
        return this;
    }

    @Override
    public ModuleBlobContentManifestRecord value3(String value) {
        setBlobContentManifestId(value);
        return this;
    }

    @Override
    public ModuleBlobContentManifestRecord value4(String value) {
        setModuleId(value);
        return this;
    }

    @Override
    public ModuleBlobContentManifestRecord value5(String value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public ModuleBlobContentManifestRecord value6(String value) {
    ...
    @Override
    public ModuleBlobContentManifestRecord values(String value1, String value2, String value3, String value4, String value5, String value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModuleBlobContentManifestRecord(String moduleBlobContentManifestId, String moduleSetReleaseId, String blobContentManifestId, String moduleId, String createdBy, String lastUpdatedBy, LocalDateTime creationTimestamp, LocalDateTime lastUpdateTimestamp) {
        super(ModuleBlobContentManifest.MODULE_BLOB_CONTENT_MANIFEST);
