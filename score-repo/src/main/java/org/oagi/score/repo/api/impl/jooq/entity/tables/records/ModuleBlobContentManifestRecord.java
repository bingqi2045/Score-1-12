...
public class ModuleBlobContentManifestRecord extends UpdatableRecordImpl<ModuleBlobContentManifestRecord> implements Record8<ULong, ULong, ULong, ULong, String, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public ModuleBlobContentManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, String value5, String value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModuleBlobContentManifestRecord(ULong moduleBlobContentManifestId, ULong moduleSetReleaseId, ULong blobContentManifestId, ULong moduleId, String createdBy, String lastUpdatedBy, LocalDateTime creationTimestamp, LocalDateTime lastUpdateTimestamp) {
        super(ModuleBlobContentManifest.MODULE_BLOB_CONTENT_MANIFEST);
