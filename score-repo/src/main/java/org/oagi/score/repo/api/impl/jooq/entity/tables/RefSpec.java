...
public class RefSpec extends TableImpl<RefSpecRecord> {
    ...
    /**
     * The column <code>oagi.ref_spec.ref_spec_id</code>. Primary, internal
     * database key.
     */
    public final TableField<RefSpecRecord, String> REF_SPEC_ID = createField(DSL.name("ref_spec_id"), SQLDataType.CHAR(36).nullable(false), this, "Primary, internal database key.");
