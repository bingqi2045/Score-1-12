...
public class AccManifestRecord extends UpdatableRecordImpl<AccManifestRecord> implements Record9<ULong, String, ULong, ULong, Byte, String, ULong, ULong, ULong> {
    ...
    @Override
    public Row9<ULong, String, ULong, ULong, Byte, String, ULong, ULong, ULong> valuesRow() {
    ...
    @Override
    public AccManifestRecord values(ULong value1, String value2, ULong value3, ULong value4, Byte value5, String value6, ULong value7, ULong value8, ULong value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccManifestRecord(ULong accManifestId, String releaseId, ULong accId, ULong basedAccManifestId, Byte conflict, String logId, ULong replacementAccManifestId, ULong prevAccManifestId, ULong nextAccManifestId) {
        super(AccManifest.ACC_MANIFEST);
