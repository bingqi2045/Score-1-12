...
public class BlobContentManifestRecord extends UpdatableRecordImpl<BlobContentManifestRecord> implements Record6<ULong, String, String, Byte, ULong, ULong> {
    ...
    @Override
    public Row6<ULong, String, String, Byte, ULong, ULong> valuesRow() {
    ...
    @Override
    public BlobContentManifestRecord values(ULong value1, String value2, String value3, Byte value4, ULong value5, ULong value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BlobContentManifestRecord(ULong blobContentManifestId, String blobContentId, String releaseId, Byte conflict, ULong prevBlobContentManifestId, ULong nextBlobContentManifestId) {
        super(BlobContentManifest.BLOB_CONTENT_MANIFEST);
