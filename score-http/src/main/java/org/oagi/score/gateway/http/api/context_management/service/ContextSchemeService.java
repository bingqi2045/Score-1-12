...
public class ContextSchemeService {
    ...
    public PageResponse<ContextScheme> getContextSchemeList(ContextSchemeListRequest request) {
        ...
        if (!StringUtils.isEmpty(request.getName())) {
            conditions.addAll(ContainsFilterBuilder.contains(request.getName(), CTX_SCHEME.SCHEME_NAME));
        }
    ...
    public PageResponse<ContextSchemeValue> getContextSchemeValueList(ContextSchemeValueListRequest request) {
        ...
        if (!StringUtils.isEmpty(request.getValue())) {
            conditions.addAll(ContainsFilterBuilder.contains(request.getValue(), CTX_SCHEME_VALUE.VALUE));
        }
